          ...
          <FadeInUp delay={0.15}>
            <div className="mx-auto mt-8 grid max-w-2xl grid-cols-3 gap-3 text-center">
              ...
              <div className="rounded-lg border border-zinc-800 bg-zinc-900/40 p-3">
                ...
                <p className="mt-1 text-[11px] leading-tight text-zinc-400">if we don&apos;t find a gap</p>
              </div>
            </div>
          </FadeInUp>
          ...
          <FadeInUp delay={0.25}>
            <div className="mt-8 flex flex-col items-center gap-3">
              ...
              <p className="text-sm font-medium text-zinc-300">
                <span className="text-amber-400">Find It or It&apos;s Free</span> &mdash; full refund if we don&apos;t find a gap your attorney hasn&apos;t raised.
              </p>
