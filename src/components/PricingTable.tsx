...
export function PricingTable({ maxTiers }: PricingTableProps) {
  ...
  return (
    <div>
      {/* Anchor */}
      <div className="mb-8 rounded-xl border border-zinc-500 bg-zinc-900/50 p-6 text-center">
          ...
          >
            ...
            {tier.valueStack && (
              <div className="mt-4 space-y-1 border-l-2 border-amber-500/30 pl-3">
                ...
                <div className="flex items-baseline justify-between text-xs font-semibold pt-1 border-t border-zinc-500">
      ...
      {!hasHiddenTiers && <div className="mt-6 grid gap-6 md:grid-cols-2">
        {tiers.slice(3).map((tier) => (
          <div
            key={tier.name}
            className="flex flex-col rounded-xl border border-zinc-500 bg-zinc-900/50 p-8"
          >
            <h3 className="text-xl font-bold text-white">{tier.name}</h3>
            <div className="mt-2">
              <span className="text-3xl font-bold text-white">
