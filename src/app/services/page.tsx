    ...
    tiers: [
      {
        ...
        slug: "case-decoder",
        price: "$197",
        desc: "Plain-English charge breakdown + 10-15 drug-case questions. Includes Defense Milestone Score — a 0-100 rating of defense milestones for your case stage.",
        discovery: false,
        popular: true,
      },
      {
    ...
    tiers: [
      {
        ...
        slug: "case-decoder",
        price: "$197",
        desc: "Your DUI charges explained in plain English. What to expect at each stage. 10-15 questions your attorney needs to answer. Includes Defense Milestone Score — a 0-100 rating of defense milestones for your case stage.",
        discovery: false,
        popular: true,
      },
      {
