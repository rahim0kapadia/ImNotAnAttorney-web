...
function CaseDetailContent() {
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      {/* ===== Tabs ===== */}
      <div className="border-b border-zinc-500 flex gap-1 overflow-x-auto">
        {TABS.map((tab) => (
          <button
            key={tab}
  ...
  return (
    <div className="rounded-xl border border-zinc-500 bg-zinc-900/50 overflow-hidden">
      <table className="w-full text-sm">
        ...
        <tbody>
          {documents.map((d) => (
            <tr key={d.id} className="border-b border-zinc-500">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {groups[severity].map((f) => (
                  <tr key={f.id} className="border-b border-zinc-500">
  ...
  return (
    <div className="rounded-xl border border-zinc-500 bg-zinc-900/50 overflow-hidden">
      <table className="w-full text-sm">
        ...
        <tbody>
          {witnesses.map((w) => (
            <tr key={w.id} className="border-b border-zinc-500">
        ...
        {citations.length === 0 ? (
          ...
          <div className="rounded-xl border border-zinc-500 bg-zinc-900/50 overflow-hidden">
            <table className="w-full text-sm">
              ...
              <tbody>
                {citations.map((ct) => (
                  <tr key={ct.id} className="border-b border-zinc-500">
                    <td className="px-4 py-3 text-zinc-200">
                      {ct.case_name}
                    </td>
        ...
        {motions.length === 0 ? (
          ...
          <div className="rounded-xl border border-zinc-500 bg-zinc-900/50 overflow-hidden">
            <table className="w-full text-sm">
              ...
              <tbody>
                {motions.map((m) => (
                  <tr key={m.id} className="border-b border-zinc-500">
                    <td className="px-4 py-3 text-zinc-200 font-medium">
                      {m.motion_name}
                    </td>
                    <td className="px-4 py-3 text-zinc-400">
