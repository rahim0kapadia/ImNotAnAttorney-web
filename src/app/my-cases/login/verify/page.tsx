"use client";
/**
 * /my-cases/login/verify#token=xxx — Customer magic link verification page.
 *
...
export default function CustomerVerifyPage() {
  ...
  useEffect(() => {
    ...
    async function verify() {
      try {
        const res = await fetch("/api/customer/magic-link/verify", {
          method: "POST",
      ...
      <div className="w-full max-w-sm text-center">
        ...
        {status === "success" && (
          <div>
            ...
            <p className="text-zinc-400 text-sm mt-2">Redirecting to your cases...</p>
          </div>
        )}
