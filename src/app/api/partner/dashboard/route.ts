  ...
  try {
    ...
    return NextResponse.json({
      partner: {
        ...
        logo_storage_path: partner.logo_storage_path ?? null,
        brand_color_primary: partner.brand_color_primary ?? null,
        brand_color_accent: partner.brand_color_accent ?? null,
        brand_color_bg: partner.brand_color_bg ?? null,
        brand_color_source: partner.brand_color_source ?? null,
        website_url: partner.website_url ?? null,
        brand_contrast_passed: Boolean(partner.brand_contrast_passed),
        brand_updated_at: partner.brand_updated_at ?? null,
      },
      earnings: {
