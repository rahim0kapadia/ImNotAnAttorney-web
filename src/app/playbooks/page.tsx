...
export default function PlaybooksCatalogPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950">
            ...
            {livePlaybooks.map((slug, i) => {
              ...
              return (
                <FadeInUp key={slug} delay={i * 0.08}>
                  <Link
                    href={`/playbook/${slug}`}
                    className="group flex h-full flex-col rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 transition-all duration-200 hover:border-amber-400/60 hover:bg-zinc-900/80"
                  >
                    {/* Charge type label */}
      ...
      <section className="border-t border-zinc-800/50 px-4 py-20 sm:px-6 lg:px-8">
