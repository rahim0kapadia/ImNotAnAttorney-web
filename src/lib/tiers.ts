...
export const TIER_CORE = {
  ...
  "case-decoder": {
    ...
    priceDisplay: "$197",
    delivery: "48 hours",
    deliveryDetail: "Every report is reviewed before delivery. You'll receive it within 48 hours of submitting your case details.",
    requiresDiscovery: false,
    isAddon: false,
  ...
  "situation-room": {
    ...
    priceDisplay: "$9,997",
    delivery: "24-48hr per stage",
    deliveryDetail: "All deliverables ship within 24-48 hours per stage. Trial Intelligence Operations activate when trial begins.",
    requiresDiscovery: true,
    isAddon: false,
    isDigitalProduct: false,
  ...
  "extra-witness": {
    ...
    description: "Extra Witness Intel deep-research add-on for active War Room engagements.",
    requiresDiscovery: false,
    isAddon: true,
    isDigitalProduct: false,
    requiresWarRoom: false,
  ...
  "officer-background-check": {
    ...
    priceDisplay: "$97",
    delivery: "Instant",
    deliveryDetail: "Your Officer Background Check is generated on demand the moment you complete purchase.",
    requiresDiscovery: false,
    isAddon: false,
    isDigitalProduct: true,
    requiresWarRoom: false,
  ...
  "similar-cases-analyzer": {
    ...
    priceDisplay: "$297",
    delivery: "Instant",
    deliveryDetail: "Your Similar Cases Analyzer report is generated on demand the moment you complete purchase.",
    requiresDiscovery: false,
    isAddon: false,
    isDigitalProduct: true,
    requiresWarRoom: false,
  ...
  "witness-pack": {
    ...
    description: "Standalone witness analysis package with 3-5 business day delivery for X-Ray and War Room engagements.",
    requiresDiscovery: true,
    isAddon: true,
    isDigitalProduct: false,
    requiresWarRoom: false,
