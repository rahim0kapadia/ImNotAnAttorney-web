...
excerpt: >-
  Missed deadlines, zero communication, no work done? Here's how to file a state
  bar complaint step by step — and what actually happens after you submit it.
author: ImNotAnAttorney Team
howToSteps:
  - name: Find your state bar's complaint form
    text: >-
      Search for '[your state] bar complaint form' or visit your state bar
      association's website. Every state has an online disciplinary complaint
      form.
  - name: Gather documentation
    text: >-
      Collect all communication records, court documents, billing statements,
      retainer agreements, and any written correspondence with your attorney.
  - name: Write a specific factual complaint
    text: >-
      Document exactly what happened with dates, times, and specifics. Focus on
      facts, not emotions. Include what your attorney did or failed to do and
      how it harmed your case.
  - name: Submit and follow up
    text: >-
      Submit the completed form with supporting documents. The process typically
      takes 6-12 months (American Bar Association disciplinary data). You will
      receive a case number for tracking.
faqs:
  - q: How do I file a bar complaint against my attorney?
    a: >-
      Go to your state bar's website and find the disciplinary complaint form.
      Gather all communication records, court documents, and billing statements.
      Write a factual complaint with specific dates and what the attorney did or
      failed to do. Submit with supporting documents and expect several months
      to over a year for resolution (American Bar Association — disciplinary
      process timelines vary by state).
  - q: What can a bar complaint actually do?
    a: >-
      A bar complaint triggers an investigation by your state's disciplinary
      body. It can result in a private reprimand, public reprimand, license
      suspension, or disbarment. It cannot get your money back or change the
      outcome of your case — for that, you need fee arbitration or a malpractice
      claim.
  - q: Should I file a bar complaint while my case is still active?
    a: >-
      Switch attorneys first to protect your active case, then file the
      complaint once your case is stabilized with new representation. Filing
      while the same attorney is still representing you creates an adversarial
      dynamic that can make your situation worse.
