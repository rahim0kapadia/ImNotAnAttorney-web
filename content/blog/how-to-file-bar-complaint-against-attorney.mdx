...
GROUP_ANSWER: Go to your state bar's website and find the disciplinary complaint form. Gather all communication records, court documents, and billing statements. Write a factual complaint with specific dates and what the attorney did or failed to do. Submit with supporting documents and expect several months to over a year for resolution.
-->
