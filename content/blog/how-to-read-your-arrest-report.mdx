...
faqs:
  - q: "Is an arrest report the same as a police report?"
    a: "They overlap but they're not the same document. The arrest report covers the arrest itself and the facts the officer used to justify it. The police report is broader — investigation notes, witness interviews, supplemental narratives. Get both. Inconsistencies between them are exactly the kind of thing that gets challenged."
  - q: "How do I get a copy of my arrest report?"
    a: "Your defense attorney gets it through discovery. You can also request it directly from the arresting agency's records division, though some jurisdictions restrict access while a case is pending. It is your right to see the document the case against you is built on. If your attorney has it and you don't, ask for a copy."
  - q: "What should I do if the arrest report is factually wrong?"
    a: "Do not contact the officer or argue about it publicly. Write down every specific thing you believe is wrong — dates, times, quotes, descriptions — with as much detail as you can remember. Give that list to your defense team. Inconsistencies between the report and other evidence like video, audio, or witness accounts are exactly what gets challenged in motions and at trial."
  - q: "Does the arrest report get shown to the jury?"
    a: "Usually not directly — it's often considered hearsay. But the officer who wrote it will testify, and the report gets used to refresh their memory and for cross-examination. When what the report says doesn't match what the officer says on the stand, that's a classic area of challenge."
---
...
<!-- SOCIAL_SPINE
HOOK: You read the arrest report. Three facts are wrong.
THREAD:
The arrest report is the prosecution's first draft, not a neutral record.
Officers reuse identical phrasing across totally different cases.
A 47-minute gap covered in two paragraphs is a summary with holes.
If the bodycam contradicts the report, the bodycam wins.
Probable cause built on conclusions instead of observations is built on sand.
"Miranda given" with no timestamp is a checkbox, not documentation.
"Defendant consented to search" is six words replacing a conversation.
A paraphrased witness statement is the officer's interpretation of someone else's words.
A report written three days later is a memory exercise, not a record.
Every inconsistency is a thread your defense can pull.
SCREENSHOT: The arrest report is the prosecution's opening argument disguised as a neutral record.
SHARE_FRAME: If you've been arrested, read this before you read anything else.
GROUP_ANSWER: They overlap but they're not the same document. The arrest report covers the arrest itself and the facts the officer used to justify it. The police report is broader — investigation notes, witness interviews, supplemental narratives. Get both. Inconsistencies between them are exactly the kind of thing that gets challenged.
-->
