...
A defendant — we'll call him R — was facing drug trafficking charges in Florida. Mandatory minimum: 3 years in state prison.

R did what most defendants do. He hired an attorney. He paid thousands of dollars upfront. He was told to trust the process.

So he trusted. For months.

No motions were filed. Phone calls weren't returned. When R asked what was happening with his case, the answer was always some version of "we're working on it" or "these things take time." If that sounds familiar, you're not alone — it's [one of the most common complaints defendants have](/blog/attorney-not-returning-calls).

Then one night, R decided to open his own discovery.

## 500 Pages

R's discovery file was approximately 500 pages. Police reports. Lab results. Witness statements. Confidential informant records. Search warrant documentation. Surveillance logs.
...
R's attorney had not raised the weight discrepancy. No motion. No written question to the prosecution. No mention of it at all.
...
In the same report — the same document — that same phone number was also attributed to R.

One phone number. Two different people. In the same report.

This kind of error undermines the foundation of the investigation. If the phone used to arrange the controlled buy belongs to the CI rather than the defendant, the entire narrative of the case changes. The prosecution's theory of how R was involved depends on correctly attributing communications.

R's attorney had not questioned the dual attribution.
...
R's attorney had not raised the mismatch between the charged substance and the lab-confirmed substance.
...
In a case alleging that R possessed and trafficked drugs, not a single fingerprint on the evidence connected him to the substance. This doesn't automatically prove innocence — it's possible to handle items without leaving prints — but it's powerful evidence that should be part of any defense strategy.

The absence of fingerprint evidence goes directly to the question of [constructive possession](/blog/trafficking-charges-constructive-possession). The prosecution has to prove R had knowledge of and control over the substance. Twenty-one fingerprints with zero matches to the defendant makes that significantly harder.

R's attorney had not mentioned the fingerprint results.

## What R's Attorney Should Have Done
...
R's attorney had filed nothing. On any of it.
...
We're not going to tell you how R's case ended. That's not the point.
