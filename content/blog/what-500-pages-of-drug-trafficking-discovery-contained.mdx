...
category: drug-cases
excerpt: >-
  A defendant opened his own 500-page discovery file and found four critical
  issues his attorney never mentioned. Here's what he found — and what it means
  for your case.
author: ImNotAnAttorney Team
faqs:
  - q: What does drug case discovery look like?
    a: >-
      Hundreds of pages. Police reports, lab results, witness statements, CI
      records, surveillance logs, search warrant affidavits, chain of custody
      docs. In the case documented here, 500 pages contained four major issues
      the attorney never raised -- a 73% weight discrepancy, a phone number
      attributed to two different people, a mismatch between the charged drug
      and the lab-confirmed drug, and 21 fingerprints with zero matches to the
      defendant.
  - q: Can you review your own discovery documents?
    a: >-
      Yes. You have the right to see every piece of evidence the prosecution has
      against you. You don't need a law degree -- you need patience and
      attention to detail. Defendants who read their own discovery regularly
      catch issues that busy or inattentive attorneys miss. In this case, the
      defendant found four critical problems in one week with no legal training.
  - q: What is a weight discrepancy in a drug case?
    a: >-
      It's when the amount weighed at the scene doesn't match the amount
      confirmed at the lab. In this case, 93.9 grams at the scene became 25.59
      grams at the lab -- 68.3 grams vanished, a 73% discrepancy. That gap is
      the difference between a trafficking charge with a mandatory prison
      sentence and a simple possession charge with probation. The attorney never
      questioned it.
