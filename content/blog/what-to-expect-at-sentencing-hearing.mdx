...
faqs:
  - q: "What is a Pre-Sentence Investigation (PSI)?"
    a: "The PSI is an interview and background check conducted by a probation officer after a conviction or plea. The officer writes a report that goes to the judge before sentencing, and in many jurisdictions that report heavily influences the sentence. In the federal system it is called the Pre-Sentence Report (PSR)."
  - q: "What is allocution at sentencing?"
    a: "Allocution is the defendant's right to speak directly to the judge before the sentence is imposed. It is the one moment in the entire case where the defendant speaks without going through the attorney, the prosecutor, or a witness stand."
  - q: "Are federal sentencing guidelines mandatory?"
    a: "Since United States v. Booker (2005), the Federal Sentencing Guidelines are advisory, not mandatory. Judges calculate the guideline range but may vary from it based on the statutory sentencing factors. State systems vary widely — some use mandatory grids, some advisory, some have no formal guidelines at all."
  - q: "What are character letters and who should write them?"
    a: "Character letters are written statements submitted to the judge describing the defendant as a person. They may come from family, employers, clergy, teachers, coaches, or community members. What they say — and what they avoid saying — can matter as much as who writes them."
---
