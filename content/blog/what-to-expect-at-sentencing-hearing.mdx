---
title: >-
  What to Expect at a Sentencing Hearing: The Room, the People, and the Weeks
  Before
date: '2026-04-09'
...
excerpt: >-
  Trial is over. Or you took a plea. Now there's a date on a calendar and nobody
  has told you what happens in that courtroom — or what's being written about
  you in the weeks before you walk in.
author: ImNotAnAttorney Team
faqs:
  - q: What is a Pre-Sentence Investigation (PSI)?
    a: >-
      It is an interview and background check run by a probation officer after a
      conviction or plea. The officer writes a report that lands on the judge's
      desk before sentencing — and in many jurisdictions that report carries
      more weight than anything said in the courtroom. In the federal system it
      is called the Pre-Sentence Report (PSR). Most defendants walk into that
      interview with zero preparation.
  - q: What is allocution at sentencing?
    a: >-
      It is the one moment in the entire case where you speak directly to the
      judge. No attorney filter. No witness stand. No objection. The judge turns
      to you and asks if you would like to say anything before sentence is
      imposed. Defendants who prepare for it make a different impression than
      defendants who improvise.
  - q: Are federal sentencing guidelines mandatory?
    a: >-
      Not since a 2005 Supreme Court ruling. The Federal Sentencing Guidelines
      are now advisory — judges calculate the range but can vary from it based
      on statutory factors. State systems vary widely. Some use mandatory grids,
      some advisory, some have no formal guidelines at all.
  - q: What are character letters and who should write them?
    a: >-
      Written statements submitted to the judge describing who you are outside
      of this charge. They come from family, employers, clergy, teachers,
      coaches, or community members. The ones that work tell specific stories,
      not adjectives. 'He drove my mother to dialysis three times a week for two
      years' does something. 'He is a good man' does nothing.
