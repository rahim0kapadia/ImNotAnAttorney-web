---
title: >-
  Can You Challenge Breathalyzer Results? The Machine Is Not the Witness You
  Think It Is
date: '2026-04-09'
...
category: dui
excerpt: >-
  You blew a number. The cop wrote it down. Everyone in the courtroom treats it
  like a confession. Here is what the machine actually measures, where it fails,
  and the calibration gaps that turn a hard number into a soft one.
author: ImNotAnAttorney Team
faqs:
  - q: How accurate are breathalyzer machines?
    a: >-
      Less accurate than the courtroom treats them. Published error margins run
      0.005 to 0.02 BAC under lab conditions. Field conditions are worse , 
      calibration drift, temperature swings, radio interference, and operator
      shortcuts all push variance higher. A reading of 0.08 may represent a real
      BAC anywhere from 0.06 to 0.10. That range straddles the legal limit.
  - q: What is the 15-minute observation period?
    a: >-
      In most states, it's a protocol requirement based on NHTSA guidelines, not
      a suggestion. The officer has to watch you for 15 to 20 minutes before the
      breath test, no burping, belching, vomiting, or putting anything in your
      mouth. The purpose is to prevent mouth alcohol from contaminating the
      sample. If the observation period wasn't followed, the result is
      scientifically compromised. Bodycam timestamps can confirm whether it
      actually happened.
  - q: Can medical conditions affect a breathalyzer result?
    a: >-
      Yes, and they do. GERD and acid reflux push stomach alcohol into the
      mouth, contaminating the breath sample. Diabetic ketoacidosis produces
      acetone that some machines read as ethanol. Ketogenic diets produce the
      same acetone byproducts. These aren't theories, they're documented in the
      forensic science literature and have been raised in published court
      opinions.
  - q: What happens if the breathalyzer was not calibrated on schedule?
    a: >-
      The presumption of accuracy that the prosecution depends on can break.
      Most states require calibration every 7 to 30 days depending on
      jurisdiction and machine model (per manufacturer and state forensic lab
      requirements). A missed interval means the state can't assume the number
      is right, they have to prove it through additional evidence. Calibration
      records are typically public and can be requested through discovery.
