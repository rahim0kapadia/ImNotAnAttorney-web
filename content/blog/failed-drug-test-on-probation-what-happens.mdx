...
faqs:
  - q: "Can one failed drug test revoke probation?"
    a: "In most jurisdictions, a single failed test for a first-time violation does not automatically result in full revocation. Judges typically use graduated sanctions — responses that escalate based on severity and history. For a first positive test, common responses include increased testing frequency, referral to substance abuse evaluation, added treatment requirements, or short jail stays. Full revocation is more common for chronic non-compliance, new criminal activity, or failure to engage with treatment."
  - q: "What is the difference between an immunoassay screen and a confirmatory test?"
    a: "An immunoassay is the initial drug screen most probation offices use. It is fast and inexpensive but has a higher false positive rate because it reacts to chemicals similar to the target substance. Certain medications, supplements, and foods can produce positive immunoassay results. A confirmatory test — typically GC-MS (gas chromatography-mass spectrometry) or LC-MS/MS (liquid chromatography with tandem mass spectrometry) — is more specific and considered the gold standard for confirming substance identification. Many jurisdictions allow confirmatory testing on request."
  - q: "Can I request a confirmatory test if I believe the initial screen was wrong?"
    a: "Yes, in most jurisdictions. The right to request confirmatory testing is often built into probation policies or may be requested through your attorney. Common reasons for requesting confirmation include prescription medications that cross-react with immunoassay panels (some SSRIs can produce false positives for benzodiazepines or amphetamines, poppy seeds can produce opiate positives, certain OTC cold medicines can produce amphetamine positives). Timing matters — request confirmatory testing as soon as possible so the original sample can still be analyzed."
  - q: "Does self-reporting a relapse help or hurt?"
    a: "Self-reporting is generally viewed more favorably than discovery by the probation officer. Judges and POs distinguish between defendants who hide violations and defendants who engage with supervision by reporting. Self-reporting does not make the violation disappear, but it can change the framing from 'we caught the defendant' to 'the defendant came forward seeking support.' For substance-related violations, self-reporting is often paired with immediate engagement in treatment."
  - q: "What is the standard of proof for drug test violations?"
    a: "Probation revocation hearings use 'preponderance of the evidence' — meaning the prosecution must show it is more likely than not that the violation occurred. This is a lower standard than 'beyond a reasonable doubt' used at criminal trials. However, the evidence must still be reliable. The defense can challenge chain of custody, lab procedures, cross-reactivity of the testing method, and whether the test was administered correctly. A positive drug test is strong evidence but it is not unchallengeable."
---
...
Before we get into process, understand what the judge is trying to figure out at a violation hearing for a positive drug test. It is not "did the defendant fail the test." The positive test result is evidence of the violation — that is step one. Step two is the question that actually decides the outcome:
...
Many jurisdictions have a procedure for requesting confirmatory testing. The specifics vary by state and by the probation office policy. Your attorney can advise whether confirmatory testing is available in your jurisdiction and whether it is worth requesting in your situation.

## What Judges Actually Consider at a Drug Test Violation Hearing

Based on published case law, state sentencing commission guidance, and judicial best-practice literature, the factors that tend to drive outcomes:
...
The window between the failed test and the hearing is preparation time. These are things defendants commonly do to improve their position — not specific legal advice for your situation.
