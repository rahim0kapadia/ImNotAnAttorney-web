...
category: probation
excerpt: >-
  You relapsed. You failed a UA. Your PO says it's a violation. Before you
  assume the worst, judges have more discretion than your PO is telling you,
  and one failed test after months of compliance tells a very different story
  than chronic non-compliance. Here's what actually happens next.
author: ImNotAnAttorney Team
faqs:
  - q: Can one failed drug test revoke probation?
    a: >-
      One failed test almost never triggers automatic full revocation. Most
      jurisdictions use graduated sanctions, increased testing, treatment
      referral, added conditions, before reaching revocation. Full revocation
      typically requires chronic non-compliance or new criminal activity, not a
      single positive.
  - q: >-
      What is the difference between an immunoassay screen and a confirmatory
      test?
    a: >-
      The immunoassay is the cheap, fast screen your PO uses. It tells you
      something in your sample looks like a drug, but it can be wrong. The
      confirmatory test (GC-MS) identifies the exact molecule. If your positive
      was only an immunoassay, your attorney can challenge reliability.
  - q: >-
      Can I request a confirmatory test if I believe the initial screen was
      wrong?
    a: >-
      Yes, in most jurisdictions. Request it through your attorney as soon as
      possible, samples degrade. Common triggers: SSRIs producing benzo
      positives, cold medicine producing amphetamine positives, poppy seeds
      producing opiate positives. The request itself often pauses the violation
      process.
  - q: Does self-reporting a relapse help or hurt?
    a: >-
      Self-reporting almost always helps. Judges distinguish between defendants
      who come forward and those who get caught. It does not make the violation
      disappear, but it reframes the narrative from 'we caught them' to 'they
      came forward seeking help.' Pair it with immediate treatment enrollment.
  - q: What is the standard of proof for drug test violations?
    a: >-
      Probation hearings use 'preponderance of evidence', lower than criminal
      trials. But the evidence still has to be reliable. Your attorney can
      challenge chain of custody, lab procedures, cross-reactivity, and whether
      the test was administered correctly. A positive test is strong evidence,
      but it is not unchallengeable.
