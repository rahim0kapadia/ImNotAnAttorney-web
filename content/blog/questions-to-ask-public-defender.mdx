...
faqs:
  - q: "What questions should I ask my public defender?"
    a: "Caseload, discovery timeline, planned motions, immediate deadlines, and realistic outcome range. Those five questions in your first 15 minutes tell you whether your case is getting real attention or default processing."
  - q: "How many cases does a public defender handle at once?"
    a: "Most carry 200 to 400+ active cases. The ABA recommends a max of 150 felonies per year. Almost every office blows past that number. It is not a skill problem — it is a math problem."
  - q: "Can I switch from a public defender to a private attorney?"
    a: "Yes, at any point. But judges rarely grant continuances for the switch if trial is close. If you are going to switch, do it early. Waiting until the last month usually means your new attorney inherits a mess with no time to fix it."
  - q: "Is a public defender as good as a private attorney?"
    a: "Many are excellent trial attorneys with more courtroom hours than most private lawyers will ever log. The issue is volume, not skill. A defender with 200 cases physically cannot give yours the same hours as a private attorney with 30. How proactive you are as a client closes that gap more than anything else."
---
...
But here's what nobody mentions: most public defender offices have one receptionist for 30 attorneys. The system is not built for communication. You have to build it yourself.
...
<!-- SOCIAL_SPINE
HOOK: You meet your public defender 5 minutes before your hearing.
THREAD:
They have 200 cases and 15 minutes for yours
The problem is not skill — it is math
Seven questions separate strategy from autopilot
Ask their caseload — their honesty tells you everything
Discovery is the prosecution's playbook — demand to see it
Zero motions filed means zero analysis done
Missed deadlines cannot be unfiled
A follow-up email creates a paper trail for the whole case
Prepared clients get strategy — unprepared clients get next time
You cannot control the system but you can control the questions
SCREENSHOT: The questions you bring to that first meeting determine whether your case gets strategy or autopilot.
SHARE_FRAME: "I found this breakdown of exactly what to ask a public defender in your first meeting"
GROUP_ANSWER: Most carry 200 to 400+ active cases. The ABA recommends a max of 150 felonies per year. Almost every office blows past that number. It is not a skill problem — it is a math problem.
-->
