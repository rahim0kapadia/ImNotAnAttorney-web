...
excerpt: >-
  The business model of criminal defense creates incentives that don't always
  align with your interests. Understanding how attorneys get paid is the first
  step to evaluating whether yours is actually fighting for you.
author: ImNotAnAttorney Team
faqs:
  - q: How do criminal defense attorneys get paid?
    a: >-
      Private criminal defense attorneys charge a flat fee retainer, an hourly
      rate, or a hybrid of both. Public defenders are government-funded and free
      to qualifying defendants. Each billing structure creates different
      incentives that shape how your case gets handled, flat fees reward speed,
      hourly billing rewards volume, and public defenders are stretched across
      hundreds of cases at once.
  - q: What is a retainer fee for a criminal attorney?
    a: >-
      A retainer is an upfront flat fee paid before work begins, typically
      thousands to tens of thousands of dollars depending on charge severity and
      jurisdiction. Trial preparation, investigators, and expert witnesses
      almost always cost extra. The retainer covers the attorney's time up to a
      defined scope, so ask exactly what is and is not included before you sign.
  - q: Why does my criminal defense attorney keep pushing a plea deal?
    a: >-
      Under a flat-fee structure, a quick plea is more profitable than months of
      motion practice followed by trial. That does not mean the plea is wrong
      for your situation, but it means you need to understand the financial
      incentive behind the recommendation. Ask for the specific sentencing
      difference between the plea and a trial loss so you can evaluate the
      numbers yourself.
