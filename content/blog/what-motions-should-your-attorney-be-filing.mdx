...
faqs:
  - q: "What motions should my attorney file in a criminal case?"
    a: "Motion to suppress illegally obtained evidence. Motion to compel discovery. Brady motion for exculpatory evidence. Motion to dismiss. Daubert or Frye motion challenging expert testimony. Motion in limine to exclude prejudicial evidence. Motion to sever co-defendants or charges. Not every motion applies to every case, but your attorney should be able to explain why each one does or does not apply to yours."
  - q: "What is a motion to suppress evidence?"
    a: "It asks the judge to throw out evidence obtained through an illegal stop, search, seizure, or interrogation. If granted, the prosecution loses that evidence entirely. In drug cases, suppressing the drugs can get the entire case dismissed. It is based on the Fourth Amendment protection against unreasonable searches and seizures, and it is one of the most powerful tools in criminal defense."
  - q: "What happens if my attorney missed the deadline to file a motion?"
    a: "Some motions have strict deadlines — suppression motions often must be filed within 30-45 days of arraignment. Miss the window and the motion is waived permanently. You lose the right to challenge that evidence, that procedure, or that violation for the rest of your case. This is why asking about motion deadlines early is not optional — it is urgent."
---
...
<!-- SOCIAL_SPINE
HOOK: Your case has been open for months and your attorney has not filed a single motion.
THREAD:
Motions are how cases are won before trial ever starts — most defendants never learn this.
A suppression motion can throw out illegally obtained evidence and end the case entirely.
Suppression motion deadlines are often 30-45 days after arraignment — miss it and the right is gone forever.
The prosecution must disclose evidence that helps your defense — a Brady motion forces compliance.
A Daubert motion can block unreliable expert testimony before the jury ever hears it.
Field drug tests have false positive rates that would disqualify them in any other context.
"Motions won't help" without a motion-by-motion explanation means the analysis was never done.
The court docket shows what was actually filed — it is the only record that matters.
A motion to sever prevents a co-defendant's confession from poisoning your trial.
A motion in limine controls what the jury sees — what they never hear cannot prejudice them.
SCREENSHOT: A motion deadline that passes without a filing is a defense option that disappears permanently.
SHARE_FRAME: "I found this breakdown of every motion your defense attorney should be filing and when the deadlines hit"
GROUP_ANSWER: Motion to suppress illegally obtained evidence. Motion to compel discovery. Brady motion for exculpatory evidence. Motion to dismiss. Daubert or Frye motion challenging expert testimony. Motion in limine to exclude prejudicial evidence. Motion to sever co-defendants or charges. Not every motion applies to every case, but your attorney should be able to explain why each one does or does not apply to yours.
-->
