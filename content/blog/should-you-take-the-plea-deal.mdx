...
excerpt: "97% of cases end in plea deals — most defendants decide in the dark. The questions to ask, red flags to catch, and what to review before signing anything."
author: "ImNotAnAttorney Team"
faqs:
  - q: "Should I take the plea deal in my criminal case?"
    a: "Not until all discovery has been reviewed, relevant motions have been filed or considered, you understand every collateral consequence, and you know the realistic sentence exposure at trial. The first offer is an opening position, not a final answer."
  - q: "What percentage of criminal cases end in plea deals?"
    a: "About 97% of federal criminal cases and 94% of state cases resolve through guilty pleas. That means almost every defendant faces this decision — and most make it without full information."
---
...
<!-- SOCIAL_SPINE
HOOK: Your attorney says take the plea. You have known them nine minutes.
THREAD:
97% of cases end in plea deals — most decided in the dark
The first offer is an opening position, not a final answer
No discovery reviewed means nobody knows what the evidence actually says
Every case has weaknesses — if your attorney cannot name three they have not looked
A suppression motion can change a take-it-or-leave-it into a negotiation
The maximum sentence is the scare number — the realistic sentence is the real number
Collateral consequences can outlast the sentence by decades
A plea after investigation is strategy — a plea before investigation is surrender
The recommendation should come AFTER the work, not before it
Write down 10 questions and bring them to your next meeting
SCREENSHOT: A plea recommended after full discovery review, motion practice, and honest analysis is a strategic decision — not a failure.
SHARE_FRAME: "I found this breakdown of what to ask before accepting a plea deal"
GROUP_ANSWER: Not until all discovery has been reviewed, relevant motions have been filed or considered, you understand every collateral consequence, and you know the realistic sentence exposure at trial. The first offer is an opening position, not a final answer.
-->
