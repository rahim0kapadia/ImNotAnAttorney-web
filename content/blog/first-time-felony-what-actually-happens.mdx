...
faqs:
  - q: "What happens when you get charged with a felony for the first time?"
    a: "Arrest, booking, and in most jurisdictions a judge within 24-48 hours. Then discovery, pre-trial motions, and either plea negotiations or trial — typically 6-12+ months total. The first 30 days matter most because evidence deadlines and diversion eligibility windows start running from arrest."
  - q: "Will I go to jail for a first-time felony?"
    a: "Not necessarily. About 33% of felony defendants in state courts are not convicted at all (Bureau of Justice Statistics). Many first-time offenders who are convicted receive probation, not incarceration. Diversion programs, deferred adjudication, and charge reductions to misdemeanors are often on the table."
