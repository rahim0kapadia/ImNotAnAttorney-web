...
faqs:
  - q: "What happens when you get charged with a felony for the first time?"
    a: "Arrest, booking, and a judge within 24-48 hours. Then discovery, pre-trial motions, and either plea negotiations or trial — typically 6-12+ months total. The first 30 days matter most because evidence deadlines and diversion eligibility windows start running from arrest."
  - q: "Will I go to jail for a first-time felony?"
    a: "Not necessarily. About 33% of felony defendants in state courts are not convicted at all. Many first-time offenders who are convicted receive probation, not incarceration. Diversion programs, deferred adjudication, and charge reductions to misdemeanors are often on the table."
  - q: "Can a first-time felony be reduced to a misdemeanor?"
    a: "Yes. Prosecutors routinely reduce felonies to misdemeanors for first-time offenders, especially when the defense shows it is prepared to fight. Diversion programs can dismiss charges entirely. Deferred adjudication keeps the conviction off your record if you complete probation."
---

<TLDRBox>
Roughly 33% of first-time felony defendants are not convicted — through dismissals, diversions, or reduced charges. First-time offenders often qualify for diversion programs or deferred adjudication that can keep a felony off your permanent record. The first 30 days after arrest are the most important: evidence preservation deadlines, motion filing windows, and diversion program eligibility all start running from your arrest date.
</TLDRBox>
...
**Approximately 33% of felony defendants in state courts are not convicted — and that number is higher for first-time offenders.**
...
You're arrested, booked, and brought before a judge within 24-48 hours for your [arraignment](/blog/what-happens-at-arraignment). The judge will inform you of charges, determine if you need a court-appointed attorney, set bail, and schedule your next date.
...
**A single successful suppression motion can collapse the prosecution's entire case — and for first-time defendants, that leverage often converts to dismissal or diversion.**
...
But here's what nobody mentions: first-time offenders have leverage that repeat offenders do not. The system has off-ramps built specifically for people with clean records — but only if someone asks for them.
...
<!-- SOCIAL_SPINE
HOOK: The word FELONY is on a piece of paper with your name on it.
THREAD:
33% of felony defendants in state courts are not convicted
A felony charge does not mean a felony conviction
The first 30 days matter more than anything that follows
Say nothing to police without an attorney — not a word
You have the right to read every piece of evidence against you
A single suppression motion can collapse the entire case
Diversion programs exist but they are requested, not offered
The biggest threat in month one is your own impulse to talk
First plea offer is almost never the best offer
The space between charge and outcome is where your defense happens
SCREENSHOT: A felony charge is not the end. It is the beginning of a process — and the more you understand that process, the better your outcome will be.
SHARE_FRAME: "I found this breakdown of what actually happens with a first-time felony charge"
GROUP_ANSWER: Not necessarily. About 33% of felony defendants in state courts are not convicted at all. Many first-time offenders who are convicted receive probation, not incarceration. Diversion programs, deferred adjudication, and charge reductions to misdemeanors are often on the table.
-->
