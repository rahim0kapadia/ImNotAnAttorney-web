...
faqs:
  - q: "What happens when you get charged with a felony for the first time?"
    a: "You'll be arrested, booked, and brought before a judge within 24-48 hours for an initial appearance. From there, your case moves through discovery, pre-trial motions, and either plea negotiations or trial — a process that typically takes 6-12+ months."
  - q: "Will I go to jail for a first-time felony?"
    a: "Not necessarily. About 33% of felony defendants in state courts are not convicted, and many first-time offenders who are convicted receive probation rather than incarceration. Options like diversion programs, deferred adjudication, and charge reductions to misdemeanors are often available."
  - q: "Can a first-time felony be reduced to a misdemeanor?"
    a: "Yes. Prosecutors will often reduce a felony to a misdemeanor for first-time offenders, especially when the defense shows it's prepared to fight. Other options include diversion programs that dismiss charges entirely and deferred adjudication where the conviction isn't entered if you complete probation."
---
