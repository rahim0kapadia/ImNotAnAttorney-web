...
faqs:
  - q: "What factors does a judge consider at a bail hearing?"
    a: "Courts generally weigh ties to the community, financial resources, nature of the offense, character and history, prior record, risk of flight, and danger to the community. The exact list and weight varies by state and whether the case is in federal or state court."
  - q: "What is the difference between a first appearance and a formal bail hearing?"
    a: "A first appearance usually happens within 24-48 hours of arrest and is fast — the judge sets initial bail based on limited information. A formal bail motion is scheduled later and allows both sides to present evidence, witnesses, and argument about release conditions."
  - q: "Does the federal Bail Reform Act apply to state charges?"
    a: "No. The Bail Reform Act of 1984 governs federal cases and creates a presumption of release for many offenses. State cases follow state statutes, which vary widely — some presume detention for violent or drug offenses."
  - q: "Can bail be changed after the first hearing?"
    a: "Often yes, through a bail modification motion. New evidence, new community ties documentation, or changed circumstances may be considered grounds to revisit the amount or conditions."
---
