...
faqs:
  - q: "What happens when you violate probation?"
    a: "Your PO files a violation report, a judge issues a warrant or summons, and you appear at a revocation hearing. The judge can add conditions, extend probation, or revoke it and sentence you to incarceration. The outcome depends on the violation type, your compliance history, and what evidence you bring to the hearing."
  - q: "Can you go to jail for a probation violation?"
    a: "Yes. If probation is revoked, the judge can impose any sentence originally available for the underlying offense, up to the maximum prison term. But technical violations like missed check-ins are far less likely to result in jail than new criminal charges. Most judges use graduated sanctions for first-time technical violations — warnings, added conditions, short jail stays — before reaching full revocation."
  - q: "What is the difference between a technical violation and a substantive violation?"
    a: "Technical means you broke a condition — missed check-in, failed drug test, missed curfew — without committing a new crime. Substantive means you were arrested for a new offense while on probation. Substantive violations are treated much more seriously because you are fighting the violation and the new charge simultaneously."
  - q: "Do you get a lawyer for a probation violation hearing?"
    a: "Yes. The Supreme Court confirmed the right to counsel at probation revocation hearings in Gagnon v. Scarpelli (1973). If you cannot afford one, the court will appoint a public defender. You also have the right to present evidence, call witnesses, and confront the prosecution's witnesses under Morrissey v. Brewer (1972)."
---
...
<!-- SOCIAL_SPINE
HOOK: You missed a check-in and now you are wondering if you are going to jail.
THREAD:
Probation violations are a process with stages, not an automatic sentence.
Technical violations and substantive violations are treated very differently.
Most judges use graduated sanctions before reaching full revocation.
The standard of proof is preponderance of evidence, not beyond a reasonable doubt.
What you do between the violation and the hearing changes the outcome.
Self-reporting a violation reframes the narrative from evasion to engagement.
One violation in an otherwise compliant period is a different story than a pattern.
Absconding turns a survivable technical violation into almost-guaranteed revocation.
Your PO's recommendation is one input — the judge makes the final decision.
You have the right to an attorney, to present evidence, and to challenge witnesses.
SCREENSHOT: What you do between the violation and the revocation hearing can dramatically affect what the judge decides — doing nothing is the worst option.
SHARE_FRAME: Know someone on probation who just messed up? This is the most useful thing you can send them right now.
GROUP_ANSWER: Your PO files a violation report, a judge issues a warrant or summons, and you appear at a revocation hearing. The judge can add conditions, extend probation, or revoke it and sentence you to incarceration. But technical violations like missed check-ins are far less likely to result in jail than new charges. Most judges use graduated sanctions — warnings, added conditions, short jail stays — before reaching full revocation. What you do between the violation and the hearing matters enormously.
-->
