...
In one case (INAA case analysis) 93.9g at the scene became 25.59g at the lab -- a 73% discrepancy the attorney missed.
...
21 fingerprints were collected in one case (INAA case analysis) and zero matched the defendant.
