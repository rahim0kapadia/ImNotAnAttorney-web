...
faqs:
  ...
  - q: Can I look up my federal judge's sentencing patterns?
    a: >-
      Yes. Our Judge Report Card pulls from this dataset and others to show your
      specific judge's departure rates, sentencing tendencies, and how they
      compare to the national average and to other judges in the same district.
...
**Go deeper:** The [Judge Report Card](/checkout?tier=judge-report-card) pulls your specific judge's sentencing history — departure rates by offense type, how they compare to the district and national averages, and patterns that are invisible from a single courtroom appearance. It is generated in under 60 seconds.
