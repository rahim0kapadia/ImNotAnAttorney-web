...
excerpt: >-
  You haven't heard from your attorney in weeks. Is that normal? Here's what
  actual communication standards look like, from what the bar requires to what
  good attorneys actually do.
author: ImNotAnAttorney Team
faqs:
  - q: How often should my attorney contact me?
    a: >-
      At minimum, monthly status updates even when nothing has changed,
      callbacks within 24-48 business hours, immediate notification of plea
      offers, and a briefing before and after every court date. That is the
      floor, not the ceiling. If you are not getting that, the representation is
      below standard.
  - q: Is it normal not to hear from my lawyer for weeks?
    a: >-
      Common, but not acceptable. ABA Model Rule 1.4 requires attorneys to keep
      clients reasonably informed and respond promptly to requests for
      information. Weeks of silence despite your outreach is a documented
      pattern that falls below professional standards and is grounds for a state
      bar complaint.
  - q: How do I get my attorney to communicate better?
    a: >-
      Send a structured email listing specific questions about discovery status,
      filed motions, prosecution communications, and upcoming deadlines. Set a
      5-business-day response deadline. If that fails, send a certified letter.
      If that fails, contact your state bar's client assistance program. Each
      step creates a paper trail that protects you.
