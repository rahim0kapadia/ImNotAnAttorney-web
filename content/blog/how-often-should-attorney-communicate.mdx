...
But that number hides something. These are the standards for attorneys who actually care about communication. The average criminal defense attorney carries 60-100 cases. Even at 48-hour callback windows, the math breaks for anyone past 40 cases.
...
So the real question becomes: if 25-30% of all bar complaints are about communication, why does the problem persist?
...
<!-- SOCIAL_SPINE
HOOK: Your attorney hasn't called back in three weeks and you're wondering if that's normal.
THREAD:
ABA Rule 1.4 requires attorneys to keep you reasonably informed about your case.
Attorney communication failures are the #1 state bar complaint at 25-30% of all filings.
A callback within 48 business hours is the professional standard, not a favor.
Monthly status updates are required even when nothing has changed.
The word "reasonably" in the rules gets defined by the attorney, not by you.
An attorney carrying 80 cases cannot communicate effectively with all of them.
Silence is not neutral — it lets your anxiety write a worse story than the truth.
A specific emailed question with a deadline is ten times harder to ignore than a voicemail.
Documentation changes how your attorney treats you before you ever file a complaint.
Every week of silence is a week your case is not being defended.
SCREENSHOT: Documentation is the single most powerful thing a defendant can do without spending a dollar.
SHARE_FRAME: "I found this breakdown of what attorney communication standards actually look like vs what most defendants get"
GROUP_ANSWER: At minimum, monthly status updates even when nothing has changed, callbacks within 24-48 business hours, immediate notification of plea offers, and a briefing before and after every court date. That is the floor, not the ceiling. If you are not getting that, the representation is below standard.
-->
