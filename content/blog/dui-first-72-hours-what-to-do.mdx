...
faqs:
  - q: "What should I do in the first 72 hours after a DUI arrest?"
    a: "Write down everything you remember about the stop and arrest before the details fade. Within 24 hours, request a DMV administrative hearing — most states give you only 7-15 days, and missing that window means automatic license suspension no matter what happens in the criminal case. Lock down your social media and do not discuss the case with anyone except your attorney."
  - q: "How long do I have to request a DMV hearing after a DUI?"
    a: "Most states give you 7 to 15 days from the date of arrest. Miss that deadline and your license is automatically suspended — no exceptions, no extensions, regardless of what happens in the criminal case. This is the single most commonly missed deadline in DUI defense because the arresting officer rarely explains it clearly."
  - q: "Should I tell my employer about a DUI arrest?"
    a: "Check your employment contract and company handbook first. Some regulated professions — CDL holders, nurses, teachers, government employees with security clearances — have mandatory self-reporting requirements with specific deadlines. Failing to report when required can carry consequences worse than the DUI itself. If your profession is not on that list, you likely have no obligation to disclose an arrest."
  - q: "Can I drive after a DUI arrest?"
    a: "In most states, you can still drive on a temporary permit or your existing license until the administrative suspension takes effect or you miss the DMV hearing deadline. The temporary driving authority is usually printed on the paperwork you received at release. Check that paperwork — the rules are different in every state."
  - q: "What evidence should I preserve after a DUI arrest?"
    a: "Save everything: GPS data showing your route, timestamped texts or receipts showing when and how much you consumed, dashcam footage, names and contact info for anyone who was with you, photos of the stop location and road conditions, and medical records for conditions that affect field sobriety tests like inner ear problems or knee injuries. Back it all up to cloud storage before anything gets lost."
howToSteps:
...
But here's what nobody mentions: your memory of this arrest is actual evidence, and it has a shelf life shorter than milk. In 48 hours, details start to blur. In a week, they are gone. Defense attorneys have used defendant-written accounts to identify procedural violations that led to case dismissals — but only when the account was written while memory was fresh.
...
<!-- SOCIAL_SPINE
HOOK: You have 7-15 days after a DUI arrest before your license disappears automatically.
THREAD:
The DMV deadline and your court date are two completely different things.
Most defendants miss the DMV hearing deadline because nobody explains it at arrest.
Your memory of the stop is evidence — write it down tonight or lose it.
Anyone you talk to about your case can be subpoenaed to repeat what you said.
One social media post can undo months of defense work.
Pleading guilty at your first appearance waives your right to challenge everything.
The officer's dashcam footage may be overwritten in 30 days if nobody requests it.
You are fighting two separate cases at once — criminal court and DMV.
Doing nothing in the first 72 hours is the most expensive decision you can make.
SCREENSHOT: The DMV deadline and the court date are two different things — miss the DMV deadline and you lose your license even if you win the criminal case.
SHARE_FRAME: "I found this breakdown of exactly what to do in the first 72 hours after a DUI — deadlines I had no idea existed"
GROUP_ANSWER: Most states give you 7 to 15 days from the date of arrest to request a DMV hearing. Miss that deadline and your license is automatically suspended — no exceptions, no extensions, regardless of what happens in the criminal case. This is the single most commonly missed deadline in DUI defense because the arresting officer rarely explains it clearly.
-->
