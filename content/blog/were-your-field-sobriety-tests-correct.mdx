...
category: dui
excerpt: >-
  NHTSA's own validation studies say the three standardized field sobriety tests
  are 77%, 68%, and 65% accurate under perfect lab conditions. Your stop wasn't
  a lab. Here's what that gap means.
author: ImNotAnAttorney Team
faqs:
  - q: What are the three standardized field sobriety tests?
    a: >-
      NHTSA recognizes three: Horizontal Gaze Nystagmus (HGN), Walk-and-Turn,
      and One-Leg Stand. Anything else the officer had you do, alphabet,
      counting backward, finger-to-nose, is not NHTSA-standardized and carries
      even lower reliability. Those non-standard tests have never been validated
      by any federal study.
  - q: How accurate are field sobriety tests according to NHTSA?
    a: >-
      NHTSA's own numbers: HGN roughly 77%, Walk-and-Turn roughly 68%, One-Leg
      Stand roughly 65%. Combined they reach about 91%, but only when every
      protocol step is followed exactly under the conditions NHTSA validated. A
      gravel shoulder at 2 AM in the wind is not those conditions. The accuracy
      drops and nobody publishes the new number.
  - q: What conditions invalidate field sobriety tests?
    a: >-
      NHTSA's own manual lists them: uneven or slippery surfaces, inadequate
      lighting, wind or weather, subjects over 65, subjects 50+ pounds
      overweight, back or leg injuries, inner ear problems, and heels over two
      inches. These are not defense theories, they are in the training
      materials the officer studied. Any single one puts the test outside its
      validation envelope.
  - q: Can field sobriety test results be challenged in court?
    a: >-
      Yes. The challenge focuses on whether the test was administered under the
      conditions NHTSA validated. Protocol deviations, environmental conditions
      outside spec, and documented physical conditions affecting performance are
      all grounds. The NHTSA manual itself says deviation from standardized
      procedures compromises validity, that is the state's own training
      material being used as the standard.
