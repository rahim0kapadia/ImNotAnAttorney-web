...
<!-- SOCIAL_SPINE
HOOK: The FBI is at your door — here's what to do in the next 48 hours.
THREAD:
By the time agents show up, they've been investigating you for months.
They are not here to ask questions — they are here to confirm what they know.
The safest number of words to say without a lawyer is zero.
A target letter means indictment is coming — it is not a bluff.
Deleting evidence adds an obstruction charge on top of what you already face.
Hire a federal defense attorney, not a state-level one.
People have beaten fraud charges and gone to prison for the cover-up.
If you proffer, go all the way — half-truths void the protection entirely.
From discovery to resolution, expect one to five years.
The first 48 hours set the trajectory for everything that follows.
SCREENSHOT: The safest number of words to say to a federal agent without a lawyer present is zero.
SHARE_FRAME: "I found this 48-hour playbook for what to do when the FBI shows up or you get a target letter"
GROUP_ANSWER: Say five words: "I want to speak with my attorney." Then stop. Do not explain, do not clarify, do not say "let me just tell you one thing." Hire a federal criminal defense attorney within 48 hours. Do not delete anything — obstruction carries up to 20 years.
-->
