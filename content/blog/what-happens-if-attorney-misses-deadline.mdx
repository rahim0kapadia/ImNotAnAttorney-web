...
excerpt: >-
  Your attorney's deadline came and went. Nothing was filed. What now? Here's
  what you need to know about missed deadlines and your options.
author: ImNotAnAttorney Team
faqs:
  - q: What happens if my lawyer misses a filing deadline?
    a: >-
      It depends on the deadline. A missed suppression motion deadline means
      evidence that could have been excluded stays admissible permanently. A
      missed appellate notice deadline — typically 30 days from sentencing — can
      permanently bar your appeal. Some deadlines have late-filing provisions if
      good cause is shown, but many do not. The damage is often irreversible.
  - q: Is a missed deadline legal malpractice?
    a: >-
      It can be. You must prove four things: your attorney owed a duty of care,
      they breached the standard by missing the deadline, the breach caused
      actual harm such as losing a viable motion or appeal, and you suffered
      quantifiable damages as a result. A missed deadline that would not have
      changed the outcome is harder to prove. A missed deadline that cost you a
      winning motion is straightforward.
  - q: What should I do if my attorney missed a deadline in my criminal case?
    a: >-
      Document everything immediately. Write down what deadline was missed, when
      you learned about it, and the consequences. Email your attorney to confirm
      the miss in writing. Ask whether a late filing is possible. If the missed
      deadline is part of a pattern of neglect, start consulting with a new
      attorney about switching. Your documentation becomes the foundation for
