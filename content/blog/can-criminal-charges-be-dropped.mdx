...
excerpt: >-
  Everyone wants their charges dropped. But how does it actually happen? Here's
  the honest breakdown, who has the power, what makes it happen, and what your
  attorney should be doing to make it possible.
author: ImNotAnAttorney Team
faqs:
  - q: Can criminal charges be dropped before trial?
    a: >-
      Yes. Charges can be dropped at multiple stages, before filing, at
      arraignment, or during pre-trial. The most common reasons are insufficient
      evidence, constitutional violations like illegal searches, witness
      credibility problems, procedural errors by the prosecution, and
      eligibility for diversion or pre-trial intervention programs. The earlier
      your attorney identifies these issues, the better the odds.
  - q: Who decides to drop criminal charges?
    a: >-
      The prosecutor has almost exclusive power to drop charges through
      prosecutorial discretion. They can decline to file, enter a nolle
      prosequi, or offer diversion programs. Judges can dismiss only for legal
      reasons like speedy trial violations or constitutional deficiencies. The
      victim does not have the power to drop criminal charges despite what TV
      shows suggest.
  - q: Can an apology or being a first-time offender get charges dropped?
    a: >-
      Neither will get charges dropped on its own. An apology is not a legal
      defense and can actually be used as evidence of guilt in court. Being a
      first-time offender does not automatically lead to dismissal, but it
      significantly increases eligibility for diversion programs that can result
      in charges being dropped upon successful completion.
