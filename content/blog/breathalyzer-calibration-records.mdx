...
faqs:
  - q: "How often do breathalyzers need to be calibrated?"
    a: "Breathalyzers are typically required to be calibrated every 30, 60, or 90 days depending on the model and jurisdiction. If the device was overdue for calibration at the time of your test, the reading is scientifically unreliable and can be challenged. A machine calibrated on a 30-day cycle that was last checked 47 days ago has produced 17 days of questionable readings — yours may be one of them."
  - q: "Can breathalyzer results be wrong?"
    a: "Most forensic breath testing devices have an accepted margin of error of plus or minus 0.005 to 0.02 BAC. A reading of .08 could actually be anywhere from .06 to .10. Results are also affected by improper calibration, uncertified operators, skipped observation periods, radio frequency interference, and individual partition ratio differences. The number on the screen is an estimate, not a fact."
  - q: "What breathalyzer records should my DUI attorney request?"
    a: "Your attorney needs to request calibration records by device serial number for 12 months before and after your test, maintenance and repair logs, operator certification and training records, the observation period log, the device operator manual for the firmware version used, and any error codes or aborted tests from your testing session. If any category is missing or shows gaps, that is a weakness in the prosecution's case."
---
...
<!-- SOCIAL_SPINE
HOOK: The number on the breathalyzer isn't a fact — it's a machine's opinion.
THREAD:
A .08 reading has a margin of error that could put your actual BAC at .06.
Breathalyzers drift over time and produce wrong numbers without regular calibration.
Departments miss calibration deadlines constantly because budgets are tight.
The officer who ran your test needs certification on that specific machine model.
The 15-minute observation period is the most commonly violated DUI procedure.
The form says the observation was completed whether it actually was or not.
Breathalyzers measure breath alcohol and estimate blood alcohol using a ratio that varies per person.
Most attorneys never request calibration records because they plan to plea you out.
If the prosecution can't produce the records, every gap is a weakness in their case.
The prosecution will never volunteer the margin of error — your attorney has to.
SCREENSHOT: A .08 reading with a margin of error means you could be at .06 — below the legal limit — and the machine would still say .08.
SHARE_FRAME: "I found this breakdown of how breathalyzer machines can produce wrong numbers and what records to request"
GROUP_ANSWER: Most forensic breath testing devices have an accepted margin of error of plus or minus 0.005 to 0.02 BAC. A reading of .08 could actually be anywhere from .06 to .10. Results are also affected by improper calibration, uncertified operators, skipped observation periods, radio frequency interference, and individual partition ratio differences. The number on the screen is an estimate, not a fact.
-->
