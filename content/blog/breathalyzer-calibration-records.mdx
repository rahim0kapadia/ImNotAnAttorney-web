...
faqs:
  - q: "How often do breathalyzers need to be calibrated?"
    a: "Breathalyzers are typically required to be calibrated every 30, 60, or 90 days depending on the model and jurisdiction. If the device was overdue for calibration at the time of your test, the reading is questionable and can be challenged in court."
  - q: "Can breathalyzer results be wrong?"
    a: "Yes. Most forensic breath testing devices have an accepted margin of error of plus or minus 0.005 to 0.02 BAC, meaning a reading of .08 could actually be anywhere from .06 to .10. Results can also be affected by improper calibration, uncertified operators, skipped observation periods, and individual partition ratio differences."
  - q: "What breathalyzer records should my DUI attorney request?"
    a: "Your attorney should request calibration records by device serial number for 12 months before and after your test, maintenance and repair logs, operator certification and training records, the observation period log, the device operator manual, and any error codes or aborted tests from your testing session."
---
