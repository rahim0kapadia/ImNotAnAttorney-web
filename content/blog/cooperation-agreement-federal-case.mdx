...
faqs:
  - q: "What is a proffer session in a federal case?"
    a: "A proffer session — sometimes called 'queen for a day' — is a meeting where you provide information to prosecutors under limited immunity. Your direct words generally cannot be used against you at trial. But prosecutors can use your statements to find other evidence, and if you lie about anything, the entire agreement is void and everything you said becomes admissible."
  - q: "What is a safety valve in federal sentencing?"
    a: "The safety valve (18 U.S.C. 3553(f)) lets judges sentence below mandatory minimums for certain drug offenses. You must meet specific criteria: minimal criminal history, no violence or weapons, not a leader in the offense, and full truthful disclosure to the government. Unlike cooperation, the safety valve is available as a matter of right if you qualify — the prosecutor cannot unilaterally deny it."
---
...
**A 5K1.1 motion is the only mechanism that allows a judge to go below a mandatory minimum — which is why cooperation has so much leverage in federal cases.**
...
But here's what nobody mentions: the questions you ask before the proffer matter more than the answers you give during it. Walking in prepared versus walking in blind is the difference between leverage and surrender.
...
But here's what nobody mentions: the cooperation timeline is not something that happens to you. Each phase has decision points where your attorney can negotiate, push back, or change course. Understanding the timeline means understanding where you have leverage.
...
<!-- SOCIAL_SPINE
HOOK: The prosecutor says "cooperate and we'll help you" — here's what that actually means.
THREAD:
A proffer protects your words but not where those words lead.
If you lie during a proffer — about anything — everything you said becomes admissible.
Cooperation agreements require you to give everything upfront — the benefit comes later.
The government decides if your cooperation was "satisfactory" — not you, not the judge.
A 5K1.1 motion is the only way below a mandatory minimum in most cases.
The safety valve does not require testifying against anyone.
Half-truths in a proffer are worse than no proffer at all.
The process from proffer to sentencing takes one to three years.
Cooperation should be a strategic choice, not a surrender.
Ask the 12 questions before you walk into that room.
SCREENSHOT: You give up everything upfront — the government decides later whether it was enough.
SHARE_FRAME: "I found this breakdown of what federal cooperation actually means — proffers, safety valves, the whole thing"
GROUP_ANSWER: A proffer session gives you limited immunity for your direct statements, but the government can use your words to find other evidence and can void the entire agreement if you lie about anything. The cooperation agreement requires complete truthfulness, testimony, and a guilty plea — and the government decides at sentencing whether your help was good enough to earn a reduced sentence. The safety valve is a separate path for certain drug offenses that does not require cooperating against anyone.
-->
