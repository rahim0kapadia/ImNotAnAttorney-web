...
faqs:
  - q: "What is the difference between expungement and record sealing?"
    a: "Expungement means the record is destroyed or removed from public databases. Sealing means it still exists but is hidden from standard background checks. The practical difference depends on your state — some use the terms interchangeably, others draw hard legal distinctions. What matters for your life is whether employers and landlords can see it. In most states, both options accomplish that."
  - q: "How long do I have to wait before applying for expungement?"
    a: "The waiting period depends on your state and the charge, and it starts from when you completed everything — prison, probation, fines, restitution, all of it. Not from the conviction date. Dismissed charges can sometimes be filed immediately. Misdemeanor convictions typically require 1-5 years. Felonies where eligible can require 3-10 years. The most common reason petitions get denied is filing before the clock actually ran out."
  - q: "Can a felony be expunged?"
    a: "In many states, yes — certain felonies can be expunged after meeting specific conditions. Violent felonies, sexual offenses, and offenses against children are excluded in most jurisdictions. Everything else depends on your state's statute, the specific charge, and whether you have completed the full waiting period with no new offenses."
  - q: "Does expungement remove my record from the internet?"
    a: "No. Expungement removes or seals government records. It does not touch news articles, social media posts, mugshot sites, or cached data in private background check databases. Those companies pull public records and store them independently. After expungement, you may need to contact those companies directly — sometimes with a demand letter — to get the outdated information removed."
---
...
<!-- SOCIAL_SPINE
HOOK: Your case ended six months ago but your background check says otherwise.
THREAD:
- Expungement closes the government's file. It does not close the internet's.
- Every state writes its own rules. What qualifies in Ohio may be ineligible in Texas.
- Dismissed charges can be filed immediately. Convictions can require a 10-year wait.
- The waiting period starts when the last obligation ends, not the conviction date.
- Most denied petitions were eligible. They just filed before the clock ran out.
- One excluded charge in a multi-count case can block the entire petition.
- After expungement you may legally answer "no" on job applications in many states.
- Private background check companies do not update automatically after expungement.
- Your eligibility is a four-variable equation. You need all four answers.
SCREENSHOT: The waiting period starts when the last obligation ends — not the conviction date, not the release date, the last day of everything.
SHARE_FRAME: If you finished your case and assumed the record would go away on its own, read this before you apply for anything.
GROUP_ANSWER: The waiting period depends on your state and the charge, and it starts from when you completed everything — prison, probation, fines, restitution, all of it. Not from the conviction date. Dismissed charges can sometimes be filed immediately. Misdemeanor convictions typically require 1-5 years. Felonies where eligible can require 3-10 years. The most common reason petitions get denied is filing before the clock actually ran out.
-->
