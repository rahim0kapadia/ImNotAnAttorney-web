...
category: dui
excerpt: >-
  You got charged with a DUI. You hired a lawyer. Now they want you to 'just
  trust the process.' Here are 5 questions that'll make sure there actually is a
  process.
author: ImNotAnAttorney Team
faqs:
  - q: What questions should I ask my DUI lawyer?
    a: >-
      Ask whether the traffic stop was legal, if they've reviewed breathalyzer
      calibration records by serial number, what motions they plan to file and
      when, whether they've obtained dashcam and bodycam footage, and what their
      actual defense strategy is beyond waiting for a plea offer. An attorney
      who can't answer these has not started working your case.
  - q: How do I know if my DUI attorney is good?
    a: >-
      A good DUI attorney can articulate a specific defense strategy that
      examines the stop legality, field sobriety test administration, chemical
      test calibration, and officer training records. They name the motions they
      plan to file and the timeline for filing them. If they speak in
      generalities or dodge basic questions about your case, that is the answer.
  - q: Should my DUI lawyer file motions in my case?
    a: >-
      Motions to suppress evidence, dismiss the case, or compel discovery are
      standard tools in DUI defense. They create leverage in plea negotiations
      and can eliminate the prosecution's strongest evidence. If your attorney
      says 'none' or 'we'll see' when asked about motions, they are not building
      a defense, they are waiting for a plea offer to forward to you.
