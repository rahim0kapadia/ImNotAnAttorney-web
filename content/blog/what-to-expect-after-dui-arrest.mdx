...
category: dui
excerpt: >-
  You just got arrested for DUI. Your hands are still shaking. Here's exactly
  what happens next — the real version, not the sanitized lawyer website
  version.
author: ImNotAnAttorney Team
faqs:
  - q: What happens after a DUI arrest?
    a: >-
      You are released on your own recognizance or after posting bail. In most
      states, within the first 7-15 days you need to request a DMV hearing to
      fight license suspension — miss that deadline and the suspension is
      automatic. You need to find an attorney within the first week, and most
      first-offense cases resolve within 3-6 months through a plea agreement or
      trial.
  - q: How long after a DUI do you go to court?
    a: >-
      Most first-offense DUI cases take 3-6 months from arrest to resolution.
      Discovery arrives in the first few weeks, motions and plea negotiations
      happen in months 2-4, and final resolution typically comes by month 4-6.
      Cases that go to trial can stretch longer.
  - q: How much does a first DUI cost in total?
    a: >-
      The total real cost of a first DUI is typically tens of thousands of
      dollars over several years (American Automobile Association DUI cost
      study). That includes attorney fees, court fines, DUI school, and
      increased insurance premiums for 3-5 years. Nobody puts that number on
      their website because it scares people away.
