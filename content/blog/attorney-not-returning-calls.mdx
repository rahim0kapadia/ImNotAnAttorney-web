...
excerpt: "Paid thousands and can't get a callback? Document every attempt, escalate the right way, and know when it's time to file a bar complaint or switch counsel."
author: "ImNotAnAttorney Team"
howToSteps:
  - name: "Document every contact attempt"
    text: "Write down every call, email, and message you've sent — date, time, method, and what you said. This paper trail is critical if you need to file a bar complaint or motion for new counsel."
  - name: "Send a formal written request"
    text: "After 2-3 unreturned calls, send a written request via email AND certified mail asking for a case status update within 48 hours. Keep a copy of everything."
  - name: "Contact the office manager or partner"
    text: "If your attorney works at a firm, contact the office manager or a senior partner directly. Explain the communication breakdown and request immediate action."
  - name: "Evaluate your options"
    text: "If communication doesn't improve, you have three options: file a bar complaint, hire a new attorney, or if you have a public defender, file a motion for substitution of counsel."
faqs:
  - q: "What do I do if my lawyer won't return my calls?"
    a: "Start documenting every contact attempt with exact dates, times, and methods. After two or three unreturned calls, send a formal written request via email and certified mail demanding a case status update within 48 hours. If that gets ignored, contact the office manager or a senior partner at the firm directly."
  - q: "Can I fire my lawyer for not communicating?"
    a: "Yes. A private attorney can be terminated at any time for any reason. For a public defender, file a motion for substitution of counsel showing a breakdown in the attorney-client relationship. Line up new representation before terminating the current one so your case has no gap in coverage."
  - q: "Is it normal for a criminal defense attorney not to call back?"
    a: "Silence for 1-2 weeks during a genuinely quiet case phase is understandable — if your attorney proactively told you nothing would happen. Anything longer than 2 weeks without communication you did not initiate, or any failure to answer a direct question within 48 business hours, is a red flag worth documenting."
---
...
<!-- SOCIAL_SPINE
HOOK: Six calls in nine days — zero callbacks from your own attorney.
THREAD:
Communication failure is the #1 bar complaint in every state.
Start a log tonight: date, time, method, what you said, what they didn't.
A certified letter with a 48-hour deadline changes the dynamic instantly.
Silence during discovery is different from silence 30 days before trial.
Check their Google reviews — if others say the same thing, you have a pattern.
An attorney doing real work on your case would have something to report.
You have the legal right to your complete case file — request it today.
Filing a bar complaint is free and takes about 30 minutes.
Generic questions get generic answers — case-specific questions get real ones.
Every day of inaction is a day where deadlines may be passing.
SCREENSHOT: Your communication log is the single most powerful tool you have against an unresponsive attorney.
SHARE_FRAME: "I found this step-by-step system for when your defense attorney goes silent"
GROUP_ANSWER: Start documenting every contact attempt with exact dates, times, and methods. After two or three unreturned calls, send a formal written request via email and certified mail demanding a case status update within 48 hours. If that gets ignored, contact the office manager or a senior partner at the firm directly.
-->
