...
Let's be real: most defense attorneys are overworked. They're juggling dozens of cases at once. Public defenders in some jurisdictions carry extremely heavy caseloads, often hundreds of active cases simultaneously. Private attorneys aren't always better, many take on as much work as they can get because that's how they pay the bills.
...
Spend a few minutes right now matching your attorney's behavior to the list above. That tells you whether your next move is a firm email or a new attorney.
...
Here's a template you can start using today. Copy this into a notebook, a Google Doc, or a note on your phone, right now, before you keep reading. That takes just a few minutes:
...
>
> As of today, I have not received a response. I am requesting the following information at your earliest opportunity:
>
...
Copy that template into a draft right now. Fill in the blanks. That takes just a few minutes, and it's the most important email you'll send this week.
...
But here's what nobody mentions: the amount of communication you should expect depends entirely on where your case is right now. Silence during discovery often means something completely different than silence shortly before trial.

**Silence shortly before trial with no strategy discussion is not a communication problem, it's a defense problem.**
...
Look up your next court date right now, it's on your paperwork or your court's online docket. That takes a few minutes and tells you which stage below applies to you.

### Pre-Arraignment (Arrest to First Court Appearance)

**Normal:** Your attorney should be in contact promptly after being retained, especially if you're in custody. They should explain the upcoming arraignment, discuss bail strategy, and answer your immediate questions.
...
**Normal:** Regular communication is reasonable during this phase. Discovery arrives in batches. Your attorney should let you know what's been received, what's outstanding, and flag anything significant. There may be legitimate stretches where nothing new arrives and there's genuinely nothing to report.
...
**Red flag:** Your trial date is approaching and you haven't discussed strategy. You don't know if there's a plea offer on the table. You don't know what witnesses are being called. You haven't prepared your testimony or discussed whether you'll testify. This is beyond a red flag, this is potential malpractice territory.

### General Rule of Thumb

**Acceptable silence:** A brief quiet stretch (waiting for discovery, waiting for a hearing date) when your attorney has proactively told you "nothing will happen for the next few weeks, I'll reach out when XYZ arrives."

**Unacceptable silence:** Any extended period without communication that you didn't initiate. Any failure to respond to a direct question within 48 business hours. Any silence when a court date is approaching.
...
Spend a few minutes right now checking your attorney's online reviews. Search their name plus "reviews", the pattern (or lack of pattern) tells you which category you're in.
...
Before the call comes, write those three questions on a sticky note and put it next to your phone. That takes just a moment and helps ensure you won't freeze when the call comes.
...
Right now, send your attorney a one-line email requesting a copy of your complete case file. You are legally entitled to it. That takes just a few minutes and tells you whether they're responsive and whether work is actually being done.
...
But here's what nobody mentions: filing a bar complaint is free, straightforward, and your communication log is exactly the evidence they need. This is not dramatic, it's a form and a paper trail.
...
Search "[your state] bar complaint form" right now and bookmark the page. That takes just a moment and removes the barrier if you need it later.
...
**Want a quick starting point?** Take the free [Case Progress Score](/score) to quickly see what's been done, what's missing, and what to push on next.
