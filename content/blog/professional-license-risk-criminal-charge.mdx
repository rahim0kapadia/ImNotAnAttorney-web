...
<!-- SOCIAL_SPINE
HOOK: A DUI plea that keeps you out of jail can trigger a license revocation the same month.
THREAD:
- Your criminal attorney and your licensing board exist in two separate universes.
- Most boards require self-reporting within 30 days of arrest. Not conviction. Arrest.
- Failure to self-report is often treated worse than the underlying charge.
- A plea that resolves the criminal case can trigger mandatory license action.
- Boards do not judge guilt. They judge fitness. Different question, different standard.
- An acquittal does not guarantee your license is safe.
- Proactive mitigation before the board asks carries more weight than reactive compliance.
- The gap between criminal strategy and licensing strategy is where careers die.
- Deferred adjudication that clears your criminal record may still count as reportable.
- Your license is six figures a year. The board timeline your attorney is not watching.
SCREENSHOT: The gap between the criminal strategy and the licensing strategy is where six-figure careers go to die.
SHARE_FRAME: If you have a professional license and a pending criminal charge, read this before your attorney negotiates any plea.
GROUP_ANSWER: In most regulated professions, yes — and the deadline is shorter than you think. Nursing boards typically require reporting within 30 days of arrest, not conviction. FINRA requires 30 days to update Form U4. Some teaching boards require 48 hours. The deadline started when you were arrested, not when your case resolves. Missing it creates a separate disciplinary problem that is often treated more seriously than the original charge.
-->
