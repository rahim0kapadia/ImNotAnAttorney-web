...
**Your Next Step:** The [Judge Report Card](/judge-report-card) pulls your assigned judge's sentencing patterns, departure rates, demographic data, and quote library from verified federal records, $197 for the intelligence that should inform every sentencing strategy.
</TLDRBox>
...
The [Judge Report Card](/judge-report-card) pulls your assigned judge's sentencing patterns, departure rates, demographic data, prosecutor pairing history, and quote library from verified federal court records. It is generated from the same 595,851-record dataset referenced in this article, plus 15,000+ judge profiles from published opinions. $197 for the intelligence that should be the foundation of every sentencing strategy.

**Facing sentencing soon?** Use the free [Federal Sentencing Calculator](/sentencing-calculator) to see aggregate sentencing data for your charge type and state, then decide whether the full Judge Report Card is worth it for your case.
