...
faqs:
  - q: "What are the stages of a criminal case?"
    a: "Nine stages: arrest and booking, first appearance or bond hearing, arraignment, discovery, motions, plea negotiations, trial (for the 3-10% that get there, per Bureau of Justice Statistics), sentencing, and appeals. Most cases resolve at the plea negotiation stage, but the real leverage is built during discovery and motions."
  ...
  - q: "Where are criminal cases actually won and lost?"
    a: "Discovery and motions — not trial. A successful suppression motion can gut the prosecution's case, and 90-97% of convictions come from plea deals negotiated based on pretrial work (Bureau of Justice Statistics). The trial threat only matters if the preparation behind it is real."
---
...
GROUP_ANSWER: Nine stages: arrest, first appearance, arraignment, discovery, motions, plea negotiations, trial (for the small percentage that get there, per Bureau of Justice Statistics), sentencing, and appeals. Most cases resolve at plea negotiations, but leverage is built during discovery and motions.
-->
