...
But here's what nobody mentions: **97% of federal convictions come from guilty pleas.** For most defendants, this stage IS the case. The trial never happens. The plea negotiation is the outcome.
...
GROUP_ANSWER: Nine stages: arrest, first appearance, arraignment, discovery, motions, plea negotiations, trial (for the 3-10% that get there), sentencing, and appeals. Most cases resolve at plea negotiations, but leverage is built during discovery and motions.
-->
