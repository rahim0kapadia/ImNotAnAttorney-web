...
excerpt: >-
  Arrest. Booking. Arraignment. Discovery. Motions. Plea. Trial. Sentencing.
  Nobody explains what actually happens at each stage, or where cases are
  actually won and lost. Here's the map.
author: ImNotAnAttorney Team
faqs:
  - q: What are the stages of a criminal case?
    a: >-
      Nine stages: arrest and booking, first appearance or bond hearing,
      arraignment, discovery, motions, plea negotiations, trial (for the 3-10%
      that get there, per Bureau of Justice Statistics), sentencing, and
      appeals. Most cases resolve at the plea negotiation stage, but the real
      leverage is built during discovery and motions.
  - q: How long does a criminal case take?
    a: >-
      Simple misdemeanors run 2-6 months. State felonies 6-18 months. Complex
      state felonies 1-3 years. Federal felonies 1-4 years. Capital cases 5-15+
      years. If yours is taking longer than these ranges with no explanation,
      that is a question worth asking.
  - q: Where are criminal cases actually won and lost?
    a: >-
      Discovery and motions, not trial. A successful suppression motion can gut
      the prosecution's case, and 90-97% of convictions come from plea deals
      negotiated based on pretrial work (Bureau of Justice Statistics). The
      trial threat only matters if the preparation behind it is real.
...
**How long it takes:** Hours. Booking is typically complete within several hours, though it can take longer depending on the facility and time of arrest.
...
You are standing in a courtroom in the same clothes you were arrested in. The judge is reading your charges out loud. Your family is in the gallery. The entire hearing will be over in minutes. The bail amount they set in the next 60 seconds determines whether you go home tonight or sit in a cell for months.
...
**What happens:** In most jurisdictions, shortly after arrest, you appear before a judge. The court formally informs you of the charges. A bail amount is set, or you're released on your own recognizance (ROR), or you're held without bail.

**How long it takes:** The hearing itself is typically brief, often lasting just minutes.
...
**How long it takes:** The hearing is often brief, lasting just minutes. It's scheduled weeks after arrest for felonies; faster for misdemeanors.
...
In one real case, we found a significant weight discrepancy between what was recorded at the scene and what arrived at the lab. An issue the attorney hadn't raised. That's the kind of finding that lives in the discovery.
...
You are sitting in a small room with your attorney. They slide a piece of paper across the table. The prosecution is offering probation on a reduced charge. Your attorney says it is a good deal. You have no way to know if that is true because you have never done this before and you have nothing to compare it to.
...
**The data point that should stop you cold:** In the federal system, approximately **97% of convictions come from guilty pleas**, not trials (Bureau of Justice Statistics). In state systems, the vast majority of convictions also come from guilty pleas (Bureau of Justice Statistics). The vast majority of criminal cases end here.
...
You are reading the trial transcript months later. Deep in the record, your attorney failed to object when the prosecution introduced evidence that had been excluded in a pre-trial ruling. That moment. Those few seconds of silence. May be the basis of your appeal. Or it may be gone forever, depending on whether the issue was preserved.
...
| **Trial** | Preparation, cross-examination, narrative, only for the small percentage of cases that get here |
