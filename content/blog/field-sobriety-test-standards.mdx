...
category: dui
excerpt: >-
  The government's own research says field sobriety tests are wrong 23% of the
  time, even when administered perfectly. Officers rarely administer them
  perfectly.
author: ImNotAnAttorney Team
faqs:
  - q: Are field sobriety tests accurate?
    a: >-
      According to NHTSA's own validation studies, even when administered
      perfectly, field sobriety tests misidentify sober people as impaired 18%
      of the time using all three tests combined. The one-leg stand alone is
      wrong more than a third of the time. Accuracy drops further when officers
      deviate from NHTSA standards, which happens in most roadside
      administrations due to rushing, bad surfaces, and skipped medical
      screening.
  - q: Can I refuse a field sobriety test?
    a: >-
      In most states, field sobriety tests are voluntary and refusing them does
      not carry the same automatic penalties as refusing a chemical breath or
      blood test. Refusal may be noted by the officer, but it cannot be used as
      direct evidence of impairment in many jurisdictions. Consequences vary by
      state, so the specifics depend on where you were stopped.
  - q: >-
      What are the most common mistakes officers make during field sobriety
      tests?
    a: >-
      Officers frequently rush the HGN eye test below the required 2-second pass
      speed, administer walk-and-turn tests on gravel or sloped surfaces instead
      of the flat dry surface NHTSA requires, skip asking about medical
      conditions that mimic impairment, fail to properly time the one-leg stand
      with an actual clock, and don't offer subjects the option to remove
      high-heeled shoes. Each deviation makes the test less reliable and more
      challengeable.
...
NHTSA's own validation studies found these accuracy rates for field sobriety tests, even when administered correctly: **HGN: 77%**, **Walk-and-Turn: 68%**, **One-Leg Stand: 65%**, **all three combined: 82%** (National Highway Traffic Safety Administration, 2006). That means even under perfect conditions, these tests misidentify sober people as impaired **18% of the time** (National Highway Traffic Safety Administration, 2006). The one-leg stand alone is wrong more than a third of the time. Officers rarely administer them perfectly.
...
But here's what nobody mentions: the 77% accuracy rate for HGN is the best-case number from a controlled indoor study (National Highway Traffic Safety Administration, 2006). On a highway shoulder with flashing lights, passing traffic, and an officer who's rushing through the protocol, the real accuracy is unknown, because nobody has studied it under those conditions.

**The government's own research says these tests are wrong 18% of the time under perfect conditions (National Highway Traffic Safety Administration, 2006), and no officer has ever administered them under perfect conditions.**
...
NHTSA only validates three field sobriety tests. Anything else, touching your finger to your nose, reciting the alphabet backward, counting backward from 100, is not standardized, not validated, and not supported by NHTSA research (National Highway Traffic Safety Administration, 2006). If an officer used non-standardized tests and cited them as evidence of impairment, that's already a problem.
...
But here's what nobody mentions: dozens of medical conditions cause the exact same eye movement the officer is looking for (National Highway Traffic Safety Administration, 2006), and officers almost never ask about any of them before starting the test.
...
The officer says, "Raise one foot six inches off the ground and count: one-thousand-one, one-thousand-two..." You lift your foot. Your leg starts shaking. Not because of alcohol, because you're 47 years old, standing on a slope, wearing dress shoes, and terrified — factors that NHTSA acknowledges can independently affect test performance (National Highway Traffic Safety Administration, 2006). At thirty-two seconds the officer writes "put foot down" on the clipboard. The form doesn't mention that he let you stand for thirty-two seconds instead of thirty.
