...
faqs:
  - q: "Are field sobriety tests accurate?"
    a: "According to NHTSA's own validation studies, even when administered perfectly, field sobriety tests misidentify sober people as impaired 18% of the time using all three tests combined. The one-leg stand alone is wrong more than a third of the time. Accuracy drops further when officers deviate from NHTSA standards."
  - q: "Can I refuse a field sobriety test?"
    a: "In most states, field sobriety tests are voluntary and you can decline them without the same automatic penalties as refusing a chemical breath or blood test. However, refusal laws vary by state, so the consequences depend on your jurisdiction."
  - q: "What are the most common mistakes officers make during field sobriety tests?"
    a: "Officers frequently rush the HGN eye test, administer walk-and-turn tests on uneven or slippery surfaces instead of the flat dry surface NHTSA requires, skip asking about medical conditions that mimic impairment, fail to properly time the one-leg stand, and don't offer subjects the option to remove high-heeled shoes."
---
