...
**Expert Insight:** "If the officer didn't follow NHTSA standards, the test results aren't standardized tests at all. They're just an officer's subjective opinion dressed up as science." — William "Bubba" Head, voted Best DUI Attorney in America by the NCDD, 48+ years of DUI defense experience.
...
But here's what nobody mentions: the 77% accuracy rate for HGN is the best-case number from a controlled indoor study. On a highway shoulder with flashing lights, passing traffic, and an officer who's rushing through the protocol, the real accuracy is unknown — because nobody has studied it under those conditions.

**The government's own research says these tests are wrong 18% of the time under perfect conditions — and no officer has ever administered them under perfect conditions.**
...
But here's what nobody mentions: at least 38 medical conditions cause the exact same eye movement the officer is looking for — and officers almost never ask about any of them before starting the test.
