...
But instinct has a sample size problem. Eight cases. Twelve cases. Maybe twenty if your attorney has been practicing in that district for decades. The JUSTFAIR dataset — hundreds of thousands of federal sentencing records aggregated from the U.S. Sentencing Commission — captures hundreds or thousands of sentences from the same judge, tracked by disposition method.
...
**At the national level, bench trials are rare.** The vast majority of the small fraction of federal cases that reach trial go to a jury. Bench trials represent a small slice of total dispositions. This means national-level bench-versus-jury comparisons suffer from sample size issues, and they mask the judge-specific variation that actually matters.
...
**A judge who has sentenced hundreds of defendants after jury trials and dozens after bench trials has left a trail. That trail is in the data. You should see it before you decide.**
...
**Then look at your judge.** The [Judge Question Brief](/checkout?tier=judge-report-card) lists questions worth asking your attorney about your specific judge's sentencing patterns, departure rates, and offense-specific tendencies. A starting point for the bench-versus-jury conversation.
...
**The bench-versus-jury decision is too important for guesswork. Hundreds of thousands of federal sentences left a trail. Your judge is in that data. See the pattern before you choose.**
