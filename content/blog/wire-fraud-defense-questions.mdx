...
excerpt: >-
  Wire fraud carries up to 20 years per count. If your attorney can't answer
  these 15 questions about your case, you need to know that before your next
  hearing.
author: ImNotAnAttorney Team
faqs:
  - q: What is wire fraud and what does the prosecution need to prove?
    a: >-
      Wire fraud requires proof of four elements: a scheme to defraud, specific
      intent to defraud, use of interstate wire communications in furtherance of
      the scheme, and that money or property was obtained or attempted. The
      government must prove all four beyond a reasonable doubt. If any single
      element fails, the charge fails.
  - q: What is the penalty for wire fraud?
    a: >-
      Wire fraud carries up to 20 years in federal prison per count. If the
      fraud affects a financial institution, the maximum jumps to 30 years per
      count with fines up to $1 million. Sentencing is driven primarily by the
      alleged loss amount, every dollar the government adds to that figure
      moves the guideline range higher.
