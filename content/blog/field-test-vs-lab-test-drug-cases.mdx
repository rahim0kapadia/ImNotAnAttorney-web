...
**Lab results take time.** Weeks. Sometimes months. Many defendants accept plea deals before the lab results are available. That means they're pleading guilty based on a presumptive test that may or may not be accurate.
...
5. **"Has the chain of custody been maintained from the scene to the lab?"** — If the substance changed hands multiple times, wasn't properly sealed, or sat in an evidence room for months, there's a chain of custody argument.
...
If your attorney is treating a presumptive positive as a foregone conclusion, they're skipping the part of the defense that could actually matter. The prosecution must prove what the substance is. A color change in a plastic pouch doesn't do that.
