...
howToSteps:
  - name: "Schedule consultations with 2-3 attorneys"
    text: "Don't hire the first attorney you talk to. Schedule initial consultations (often free) with at least 2-3 attorneys who handle your specific charge type."
  - name: "Ask about their specific experience with your charges"
    text: "During each consultation, ask how many cases like yours they've handled, what their typical approach is, and what outcomes they've achieved. Specifics matter more than years of experience."
  - name: "Evaluate communication and trial readiness"
    text: "Ask about their communication policy, who will actually work on your case, and how many times they've gone to trial in the last year. An attorney who never goes to trial has less leverage in plea negotiations."
  - name: "Get the full cost breakdown"
    text: "Ask what the retainer covers versus what costs extra. Specifically ask: does this include trial, or just plea negotiations? What about investigators and expert witnesses? Get the answer in writing."
  - name: "Compare answers and watch for red flags"
    text: "Compare each attorney's answers side by side. Red flags: guaranteeing outcomes, pressuring you to sign immediately, badmouthing other attorneys, or being evasive when you ask specific questions."
faqs:
  - q: "What should I ask a criminal defense attorney before hiring?"
    a: "Start with the only question that matters: how many cases exactly like yours have they handled in this county? Then ask who actually does the work on your case, what their communication policy is, and get the total cost in writing -- retainer, trial, experts, everything. If they dodge any of these, that tells you what you need to know."
  - q: "How do I choose a good criminal defense lawyer?"
    a: "Interview at least three. The right attorney gives you specific numbers -- cases handled, trial outcomes, response times -- not vague reassurances. They specialize in your charge type, they have recent trial experience, and they don't pressure you to sign today. Compare answers side by side. The differences will be obvious."
  - q: "What are red flags when hiring a criminal defense attorney?"
    a: "Guaranteeing outcomes before seeing evidence is the biggest one -- that's either dishonest or reckless. Other red flags: pressuring you to sign immediately, badmouthing other attorneys instead of explaining their own track record, getting evasive when you ask specific questions, and a chaotic office that suggests they're juggling too many cases."
---
...
<!-- SOCIAL_SPINE
HOOK: You're about to hand someone $25,000 to defend your freedom.
THREAD:
Most defendants never ask a single hard question during the consultation.
The attorney who guarantees your outcome before seeing evidence is the one to avoid.
Ask how many cases like yours they've handled -- not criminal cases, YOUR charge type.
"I fight hard for all my clients" means nothing without a specific strategy for your charges.
The senior attorney does the consultation -- a junior associate might do the actual work.
A low retainer often only covers the plea deal -- motions and trial cost extra.
Prosecutors know which attorneys will fold -- and offer their worst deals to those attorneys.
If they pressure you to sign today, that tells you everything about how they operate.
Send one email within 24 hours confirming your communication agreement -- it changes the dynamic.
Start a case log on day one -- every call, every promise, every document.
SCREENSHOT: The right attorney won't resent your questions -- they'll respect that you showed up prepared.
SHARE_FRAME: "I found this breakdown of exactly what to ask before hiring a criminal defense attorney"
GROUP_ANSWER: Start with the only question that matters: how many cases exactly like yours have they handled in this county? Then ask who actually does the work, what their communication policy is, and get the total cost in writing. If they dodge any of these, that tells you what you need to know.
-->
