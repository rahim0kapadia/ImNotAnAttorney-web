...
faqs:
  - q: "What percentage of sex offense cases result in conviction?"
    a: "Less than 4% of reported sexual assaults result in a sex crime conviction, according to an NBC News investigation of DOJ data. Many cases are dismissed, reduced, or resolved without a conviction on the original charge."
  - q: "Will I have to register as a sex offender if convicted?"
    a: "If convicted of a qualifying sex offense, registration is mandatory in all 50 states. A judge cannot waive it. The only ways to avoid registration are charge dismissal, acquittal, or pleading to a non-qualifying offense."
  - q: "Can sex offense charges be based only on someone's word with no physical evidence?"
    a: "Yes. Cases can be prosecuted on testimony alone. However, the prosecution must still prove guilt beyond a reasonable doubt. Defense attorneys challenge credibility, inconsistent statements, motive to fabricate, and the reliability of memory over time."
  - q: "What are the collateral consequences of a sex offense conviction beyond prison?"
    a: "Collateral consequences include mandatory sex offender registration (20 years to lifetime), housing restrictions near schools and parks, exclusion from federally assisted housing, employment limitations, passport notation under International Megan's Law, mandatory 21-day advance travel notification, and potential denial of entry by foreign countries."
  - q: "How much does a sex offense defense attorney cost?"
    a: "Defense attorneys report that it is not uncommon for sex offense cases to cost over $50,000 in legal fees — and that is considered the low end of appropriate legal effort given the stakes involved, including potential prison time and lifetime registration."
---
