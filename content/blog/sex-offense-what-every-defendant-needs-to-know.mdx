...
excerpt: >-
  Facing sex offense charges? The conviction funnel, defense strategies elite
  attorneys use, collateral consequences most defendants learn about too late,
...
faqs:
  - q: What percentage of sex offense cases result in conviction?
    a: >-
      Less than 4% of reported sexual assaults result in a sex crime conviction,
      according to an NBC News investigation of DOJ data. Many cases are
      dismissed, reduced, or resolved without a conviction on the original
      charge. That does not mean charges are not serious, it means the path
      from accusation to conviction is not a straight line, and real defense
      opportunities exist at every stage.
  - q: Will I have to register as a sex offender if convicted?
    a: >-
      If convicted of a qualifying sex offense, registration is mandatory in all
      50 states. A judge cannot waive it. The only ways to avoid registration
      are charge dismissal, acquittal, or pleading to a non-qualifying offense.
      This is why negotiation skill matters so much, the difference between a
      qualifying and non-qualifying charge can be the difference between decades
      on a registry and a clean record.
  - q: >-
      Can sex offense charges be based only on someone's word with no physical
      evidence?
    a: >-
      Yes. Cases can be prosecuted on testimony alone, there is no legal
      requirement for physical evidence, DNA, or medical findings. But the
      prosecution still has to prove guilt beyond a reasonable doubt. The
      absence of corroborating evidence is itself a powerful defense argument.
      Defense attorneys challenge credibility, inconsistent statements, motive
      to fabricate, and the reliability of memory over time.
  - q: >-
      What are the collateral consequences of a sex offense conviction beyond
      prison?
    a: >-
      Collateral consequences include mandatory sex offender registration (20
      years to lifetime), housing restrictions near schools and parks, exclusion
      from federally assisted housing, employment limitations, passport notation
      under International Megan's Law, mandatory 21-day advance travel
      notification, and potential denial of entry by foreign countries. Courts
      are not legally required to tell you about most of these before you accept
      a plea.
  - q: How much does a sex offense defense attorney cost?
    a: >-
      Sex offense defense cases are among the most expensive criminal cases to
      fight, and the cost of not fighting aggressively is almost always higher
      given the stakes. Prison time, lifetime registration, career destruction,
      housing restrictions, and travel limitations are all on the table. The
      cost of not fighting aggressively is almost always higher than the cost of
      defense.
