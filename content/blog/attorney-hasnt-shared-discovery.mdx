...
tags: ["discovery", "attorney communication", "defendant rights", "criminal defense"]
category: "general-defense"
excerpt: "Your attorney has the evidence file and you haven't seen it. Here's what discovery delays actually mean, 3 things to do this week, and the mistake that costs months."
author: "ImNotAnAttorney Team"
question_count: 4
faqs:
  - q: "How long does the prosecution have to turn over discovery?"
    a: "There's no single nationwide deadline. In many states, initial disclosure is required within 15 to 30 days of arraignment. Some jurisdictions tie discovery deadlines to the trial date, not the arrest date. Ask your attorney what the specific deadline is in your jurisdiction — and whether it's already passed."
  - q: "Can I ask the court to force the prosecution to hand over evidence?"
    a: "Yes. Your attorney can file a motion to compel — a formal request asking the judge to order the prosecution to produce evidence they haven't turned over. If your attorney hasn't mentioned this option and discovery has been delayed for weeks or months, ask them directly why a motion to compel hasn't been filed."
  - q: "What if my attorney has discovery but won't show it to me?"
    a: "In most jurisdictions, your attorney isn't required to hand you physical copies of every document. But they are required to discuss the evidence with you and explain how it affects your defense. If your attorney received discovery weeks ago and hasn't reviewed it with you, that's a specific problem — put that question in writing and keep a copy."
  - q: "What's the difference between a discovery delay and a discovery violation?"
    a: "A delay means evidence is coming slowly — usually fixable with a continuance or a motion to compel. A violation means evidence was withheld, hidden, or destroyed — the prosecution is constitutionally required to disclose favorable evidence, and failure can be grounds for dismissal or a new trial. The first step is knowing what evidence should exist so you can spot what's missing."
---
