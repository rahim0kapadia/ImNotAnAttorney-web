...
excerpt: >-
  The system isn't designed to explain itself to defendants. These 7 things are
  routinely hidden in plain sight — and each one pairs with a question you can
  ask right now.
author: ImNotAnAttorney Team
faqs:
  - q: What don't they tell you about the criminal justice system?
    a: >-
      Most defendants never learn that public defenders carry 200-500+ cases at
      once (NLADA/ABA public defender caseload studies), that plea deals are
      negotiable opening positions, that you can request new counsel mid-case,
      that discovery review is your right, and that motion deadlines can close
      permanently if missed. Each of these facts changes how you interact with
      your own defense.
  - q: Is the criminal justice system rigged against defendants?
    a: >-
      The system is designed for efficiency, not individual justice. 97% of
      federal cases end in pleas — not because 97% of defendants are guilty, but
      because the trial penalty makes fighting too expensive in years of
      freedom. Informed defendants who ask the right questions and hold their
      attorneys accountable get measurably better outcomes than those who stay
      silent.
