...
faqs:
  - q: "What is the difference between a field test and a lab test?"
    a: "Field tests are cheap color-change kits used roadside or at booking — they are preliminary only and have documented false positive rates from substances as common as soap and chocolate. Lab tests use immunoassay screening first, then gas chromatography-mass spectrometry (GC-MS) as confirmation. GC-MS is the forensic standard. Anything that stopped at a field kit or immunoassay alone is scientifically incomplete."
  - q: "Can over-the-counter medications cause a false positive?"
    a: "Yes, and it's more common than most people realize. Pseudoephedrine in cold medicine can trigger amphetamine results. Ibuprofen has been documented to cross-react with THC on some immunoassays. Poppy seeds can trigger opiate results. Sertraline (Zoloft) can trigger benzodiazepine results. These are documented cross-reactants in the forensic toxicology literature, not theories."
  - q: "Does a positive marijuana test prove I was impaired?"
    a: "No. THC metabolites can remain detectable in urine for 30 or more days after last use. A positive test confirms presence of metabolites, not impairment at the time of any specific event. 'At some point in the last several weeks' is not 'at the time of the traffic stop.' This is one of the most commonly misunderstood facts in drug prosecutions."
  - q: "What is chain of custody and why does it matter?"
    a: "Chain of custody is the paper trail from collection cup to courtroom. Every handoff, seal, timestamp, and storage condition has to be documented. A gap — an unlabeled sample, a broken seal, a missing signature, an unexplained delay — means the prosecution cannot prove the sample they tested is the sample that came from you. That gap is grounds to challenge the evidence."
---
...
<!-- SOCIAL_SPINE
HOOK: The test came back positive. You know you didn't use.
THREAD:
Drug testing is two tests — the cheap one has the known error rate.
A positive immunoassay without GC-MS confirmation is a guess wearing a lab coat.
Field test kits produce false positives from soap, chocolate, and breath mints.
The ibuprofen in your medicine cabinet can make an immunoassay say you used marijuana.
Hair follicle tests bind metabolites more readily to darker hair — documented racial bias.
A chain-of-custody gap means they cannot prove the sample they tested is yours.
A positive marijuana test proves metabolites, not impairment at any specific time.
Different labs use different cutoff thresholds for the same substance.
The manufacturers print "presumptive only" on the packaging — it rarely reaches the courtroom.
Every failure mode is documented in forensic toxicology literature.
SCREENSHOT: A positive immunoassay without GC-MS confirmation is a guess wearing a lab coat.
SHARE_FRAME: If someone you know tested positive and it doesn't add up, share this.
GROUP_ANSWER: Yes, and it's more common than most people realize. Pseudoephedrine in cold medicine can trigger amphetamine results. Ibuprofen has been documented to cross-react with THC on some immunoassays. Poppy seeds can trigger opiate results. Sertraline (Zoloft) can trigger benzodiazepine results. These are documented cross-reactants in the forensic toxicology literature, not theories.
-->
