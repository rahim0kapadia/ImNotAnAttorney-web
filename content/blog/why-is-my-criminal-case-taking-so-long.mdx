...
faqs:
  - q: "Why is my criminal case taking so long?"
    a: "It depends on what kind of case you have and what is actually happening behind the scenes. Felonies routinely take 6-18 months in state court. The real question is not how long but whether your attorney can point to specific work — motions filed, discovery reviewed, negotiations advanced. If the only answer is 'these things take time,' that is a red flag, not an explanation."
  - q: "How long can a criminal case be continued?"
    a: "There is no hard cap on the total number of continuances, but the Sixth Amendment and state speedy trial statutes set outer limits. Simple misdemeanors typically resolve in 1-4 months, DUIs in 3-6, state felonies in 6-18, federal felonies in 12-24+. Complex multi-defendant cases can legitimately stretch 18-36 months. Your attorney should be able to explain exactly why each continuance was necessary."
  - q: "How do I know if my attorney is actually working on my case?"
    a: "Pull the court docket yourself and count the filings. A working attorney leaves evidence — motions, discovery requests, hearing notices, status conferences. If you see zero filings in 3+ months, that is not a busy court. That is an inactive case. The docket does not lie, even when people do."
---
...
<!-- SOCIAL_SPINE
HOOK: Your case has been pending for months and nobody will explain why.
THREAD:
- Misdemeanors take 1-4 months. Felonies take 6-18. Know the benchmark.
- "These things take time" is not an answer. It is a deflection.
- Pull the court docket yourself. Count the filings. That number is the truth.
- Zero motions after six months means zero work after six months.
- Strategic delay is real. But your attorney must name what the delay is buying.
- Five continuances with no explanation is not busy. It is absent.
- The prosecution being ready while your side is not means the power flipped.
- Your speedy trial rights may have been waived without your knowledge.
- An attorney who never contacts you first has deprioritized your case.
- The docket does not lie, even when people do.
SCREENSHOT: The court docket does not lie — if there are zero filings in three months, the case is not moving, no matter what anyone tells you.
SHARE_FRAME: If your case has been dragging for months with no explanation, read this before your next court date.
GROUP_ANSWER: Pull the court docket yourself and count the filings. A working attorney leaves evidence — motions, discovery requests, hearing notices. If you see zero filings in 3+ months, that is not a busy court. That is an inactive case. The docket does not lie, even when people do.
-->
