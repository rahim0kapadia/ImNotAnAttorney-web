...
created: 2026-04-03
agent: atlas
title: "Red Flags Your Attorney Isn't Working Your Case"
slides: 8
format: 1080x1350px (4:5 portrait)
suggested_posting_time: "Monday 12:00 PM EST"
kpi_target: saves
share_trigger: "A defendant reads this and recognizes their own situation. Saves it as evidence for a bar complaint or to show family."
source: content/twitter/thread-02-red-flags.md
---

## Instagram Carousel: Red Flags Your Attorney Isn't Working Your Case

**Type**: Carousel (8 slides)
**Format**: 1080x1350px (4:5 portrait)
**Suggested time**: Monday 12:00 PM EST

---

### Visual Direction

Same design system as Post 01:
- Background: #0a0a0a solid
- Headlines: Playfair Display 700, #ededed
- Body: Lato 400, zinc-400
- Accent: amber (#f59e0b) for red flag indicators and key phrases
- Red flag icon: Small amber triangle with "!" on each flag slide (top-left, replacing the number)
- Bottom: @im_not_an_attorney in Lato 300, zinc-700
...
**Subtext**: If you recognize 3 or more, keep reading.

**Design**: "7 red flags" in amber. "keep reading" in amber. Rest in white/zinc-400.

**Alt text**: 7 red flags your criminal defense attorney isn't working your case. If you recognize 3 or more, keep reading.
...
**Body**: One missed call is normal. A pattern of silence is not. Your freedom is on the line. If they can't respond within 48 hours with at least an update, they're either overwhelmed or they don't care. Either way, your case suffers.

**Design**: Amber warning triangle top-left. "pattern of silence" in amber.
...
**Design**: Both numbers in amber. "benefits them, not you" in amber.
...
**Small text**: @im_not_an_attorney | imnotanattorney.com
**Disclaimer**: This is information, not legal advice. We are not attorneys.

**Design**: "How many did you recognize?" in Playfair Display 700, amber. "HELP" in amber. Disclaimer in zinc-700.

---

### Caption

7 red flags your criminal defense attorney isn't working your case.

This isn't about having a bad attorney. It's about knowing the difference between an attorney who is working and one who isn't.
...
If you recognized 3 or more: take the free Defense Milestone Score (link in bio). It takes 60 seconds and tells you exactly where your case defense stands.

If you don't know where to start: DM "HELP" and I'll send you the first thing to do.

This is information, not legal advice. We are not attorneys.
.
.
.
#criminaldefense #attorneyredflag #DUIdefense #knowyourrights #criminallaw #defendantrights #criminaldefenseattorney #legalrights #criminaldefensetips #attorneyaccountability #fireYourLawyer #duihelp #felonycharges #courtroom #legalhelp
