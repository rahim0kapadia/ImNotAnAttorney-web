...
title: "Quora Answer: 7 Things Criminal Justice Won't Tell You"
blog_source: 7-things-criminal-justice-wont-tell-you
suggested_time: "Weekday 10:00 AM EST"
---

## Quora: INNA-Q27 | What are things the criminal justice system doesn't tell defendants?
...
**The trial penalty is real.** If you reject a plea deal and go to trial and lose, you will almost certainly get a harsher sentence than if you had taken the deal. This isn't written anywhere. It's not a formal policy. But it's been documented by criminal justice researchers and former prosecutors as one of the most powerful forces in the system. In federal cases, the difference can be three to six times longer. That's the cost of exercising a constitutional right.
...
**Judge patterns are public record.** Some judges grant suppression motions at high rates. Some almost never do. Some are lenient with first offenders. Some aren't. This data is available, and the best defense attorneys use it to shape strategy. The question is whether your attorney is paying attention to who your specific judge is.

**Bar complaints are available right now.** In every state, you can file a formal complaint if your attorney isn't communicating, isn't performing work, or is neglecting your case. Most defendants have no idea this process exists. The number one category of bar complaints nationally is attorneys failing to return calls.
