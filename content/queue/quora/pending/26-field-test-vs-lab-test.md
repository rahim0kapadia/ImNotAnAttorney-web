...
title: "Quora Answer: Field Test vs Lab Test"
blog_source: field-test-vs-lab-test-drug-cases
suggested_time: "Weekday 10:00 AM EST"
---

## Quora: INNA-Q26 | The police field test said my substance was positive for drugs. Is that reliable?
**Topics**: Drug Cases, Field Testing, Lab Testing, Criminal Evidence, False Positives
**SEO**: "drug field test reliability" / "field test false positive" / "presumptive positive drug test"
...
1. Was the substance identified by field test only, or has a lab confirmation been completed?
2. What were the specific lab results, and do they match the field test?
3. Can we challenge the field test evidence under Daubert or Frye?
4. Has the chain of custody been maintained from scene to lab?
5. Should we request an independent lab test?

Don't plead to a color change.

**Image direction**: Side-by-side comparison of field test kit vs. GC-MS lab equipment | **Republish to**: Blog link in bio
