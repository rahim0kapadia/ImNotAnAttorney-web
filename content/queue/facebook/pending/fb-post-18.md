...
**Suggested time**: Friday 6:00 PM ET
...
- Is there dashcam footage of the stop? Does it match the police report?
- What was the stated reason for the stop, and does the evidence support it?

THE FIELD SOBRIETY TESTS:
- Were the tests administered according to NHTSA standards?
- What were the conditions? Flat surface? Adequate lighting? Weather?
- Was the officer certified to administer the tests?
- Were the results recorded accurately?

THE BREATH TEST:
- Was the breathalyzer device properly calibrated?
- When was it last calibrated? Is there a calibration record?
- Was the 15-20 minute observation period followed before the test?
- Did anything happen during the observation period (burping, vomiting, use of mouthwash) that could affect the result?

THE BLOOD TEST (if applicable):
- Was the draw conducted by a qualified technician?
- Was the chain of custody maintained?
- Were the samples stored properly?
...
(This is information, not legal advice. DUI laws and procedures vary by state.)
...
First comment (pinned): "We wrote a complete DUI defense guide covering every stage from the traffic stop to the hearing. Link: imnotanattorney.com/blog/complete-dui-defense-guide"

### Engagement Strategy

DUI support groups are hungry for this kind of specific, actionable content. Monitor for comments asking about specific DUI elements (calibration records, observation periods, DMV deadlines). Respond with information from the blog posts, framed as questions to ask the attorney. Do NOT evaluate anyone's DUI case.

### UPL Compliance Note

This post provides a checklist of questions, not legal analysis. It explicitly states "this is not legal advice." Each item is framed as something to discuss with your attorney, not something to act on independently. State variation is noted.
