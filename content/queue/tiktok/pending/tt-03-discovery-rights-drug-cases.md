...
[SECOND 0-1]
**Visual**: A thick manila folder labeled "DISCOVERY" gets slammed on a table. Papers spill out slightly.
**Text overlay**: "Your attorney said they reviewed discovery."
**Audio**: Heavy thud sound effect.

[SECOND 1-3]
**Visual**: Hands flip open the folder. Camera zooms into a page showing a police report.
**Audio/Voiceover**: "But did they check what's MISSING?"
...
[SECOND 18-28]
**Visual**: Text list appearing on screen, one item at a time.
**Audio/Voiceover**: "Ask your attorney these exact questions: Has all discovery been received? Have you filed a Brady demand? Is there body cam or dashcam footage that should exist but isn't in discovery? Do the weights match between the field report and the lab report?"
**Text overlay**: Each question appears as spoken.
...
[SECOND 38-45]
**Visual**: Back to person, holding up the discovery folder. Direct eye contact.
**Text overlay**: "Gaps are evidence. imnotanattorney.com"
**Audio/Voiceover**: "Gaps aren't accidents. Gaps are evidence."

---

### Caption
Your attorney says they reviewed discovery. But in drug cases, what's MISSING is where your defense lives. Body cam that should exist. Lab results that don't match the field test. Chain of custody gaps. These are questions, not accusations.

### Hashtags
#drugcharges #discoverymatters #criminaldefense #knowyourrights #drugdefense #Bradyviolation

### Cover Image Direction
Manila folder on table with "DISCOVERY" written on it. Red circles on documents visible underneath. Text: "What's Missing Is the Defense."
