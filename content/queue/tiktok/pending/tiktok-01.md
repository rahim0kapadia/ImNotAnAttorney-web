# TikTok Script #1: Chocolate Tested Positive for Marijuana
...
[SECOND 0-1]
**Visual**: Close-up of a chocolate bar on a table. An officer's hand places a field test kit next to it.
**Text overlay**: "This chocolate bar tested positive for marijuana."
**Audio**: Dead silence. Then a low bass hit.

[SECOND 1-3]
**Visual**: Cut to speaker, eyebrows raised, direct eye contact.
**Audio/Voiceover**: "And someone went to jail for it."
...
## CTA
Visit imnotanattorney.com/score to check your defense for free.

## On-Screen Text
- 0:00 "This chocolate bar tested positive for marijuana."
- 0:03 "CHOCOLATE. ASPIRIN. BAKING SODA. OREGANO."
- 0:10 "Field test: color in a bag. Lab test: actual science."
- 0:18 "ASK: Have you compared field vs. lab results?"
...
**Context**: Sourced from the field-test-vs-lab-test-drug-cases blog post. The chocolate hook is a genuine documented false positive that creates immediate shock and curiosity. Targets anyone facing drug charges who may not know their "evidence" is a screening tool, not proof.
**Loop strategy**: Opens with chocolate bar + field test, closes with chocolate bar + NOT GUILTY stamp. The visual contrast between accusation and vindication drives rewatches.
**KPI target**: Shares (this is a "did you know" fact that people send to anyone facing drug charges)
