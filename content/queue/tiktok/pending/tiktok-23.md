# TikTok Script #23: The Judge Has a Pattern. Your Attorney Should Know It.
...
[SECOND 0-1]
**Visual**: A judge's bench from a courtroom. Over it, data overlays appear: "SUPPRESSION GRANTED: 62%" "PLEA ACCEPTANCE: 89%" "AVG SENTENCE: 14 months above guideline."
**Text overlay**: "Your judge has a track record. It's public information."
**Audio**: Courtroom gavel. Data processing sounds.

[SECOND 1-3]
**Visual**: Cut to speaker, one eyebrow raised.
**Audio/Voiceover**: "Some judges grant suppression motions at high rates. Some never do. Your attorney should be tailoring strategy to your specific judge. Are they?"
...
**Audio/Voiceover**: "This is not about gaming the system. It's about being strategically prepared. Every trial attorney worth their fee knows the judge. They know which arguments land and which ones don't. If your attorney hasn't researched your judge, they're preparing a generic defense for a specific situation."
**Text overlay**: "Generic defense for a specific judge = unprepared."

[SECOND 20-27]
**Visual**: Questions appearing on screen.
**Audio/Voiceover**: "Ask your attorney: what do you know about this judge's ruling patterns? How does this judge typically handle suppression motions? What's this judge's sentencing history compared to guidelines? And have you appeared before this judge before?"
...
## CTA
Follow for the questions that separate prepared attorneys from unprepared ones.

## On-Screen Text
- 0:00 "Your judge has a track record. It's public."
- 0:01 "Is your attorney using it?"
- 0:03 "Judge A: 65% suppression. Judge B: 8%."
- 0:12 "Generic defense for specific judge = unprepared."
- 0:20 "ASK: Judge's patterns?"
