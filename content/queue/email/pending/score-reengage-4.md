...
2. $197. 15 questions. 48 hours. That's the offer.
3. Your score was {{SCORE}}. What are you going to do about it?

## Preview Text
This is the last time we'll pitch you on this. After today, we go back to free content.
...
<!, 
  ...
  Trigger: Email 3 sent, no purchase
  Delay: Day 30 after score completion
  Segment: score-page subscribers, no purchase, completed Emails 1-3 without converting
  Exit condition: Purchase completed (any tier) = exit flow
  Note: After this email, subscriber returns to general nurture/newsletter list

  Subject line: 30 days since your score. One more shot.
...
<p>A month ago, you scored {{SCORE}}/100 on the Defense Milestone Score.</p>
...
<div style="margin: 24px 0; padding: 20px; border: 2px solid #F59E0B; border-radius: 8px; background: #1C1917;">
  ...
  <table style="width: 100%; border-collapse: collapse;">
    <tr>
      <td style="padding: 8px 0; border-bottom: 1px solid #27272A; color: #F59E0B; font-size: 13px; width: 24px; vertical-align: top;">&#10003;</td>
      <td style="padding: 8px 12px; border-bottom: 1px solid #27272A; color: #D4D4D8; font-size: 14px;">15 calibrated questions in 6-part format (question + context + what to listen for + follow-up probes + red flag response + fallback)</td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="padding: 8px 0; border-bottom: 1px solid #27272A; color: #F59E0B; font-size: 13px; vertical-align: top;">&#10003;</td>
      <td style="padding: 8px 12px; border-bottom: 1px solid #27272A; color: #D4D4D8; font-size: 14px;">Ready-to-send email template + phone script for your attorney</td>
    </tr>
    <tr>
      <td style="padding: 8px 0; border-bottom: 1px solid #27272A; color: #F59E0B; font-size: 13px; vertical-align: top;">&#10003;</td>
    ...
    <tr>
      ...
      <td style="padding: 8px 12px; color: #D4D4D8; font-size: 14px;">Delivered within 48 hours or your money back</td>
    </tr>
  </table>
...
<p>Every dollar you spend is credited toward higher tiers. If the Case Decoder helps and you want the full Intelligence Brief ($997) or X-Ray ($2,497) later, your $197 is credited in full.</p>

<div style="margin: 20px 0; padding: 16px; border: 1px solid #27272A; border-radius: 8px; background: #1C1917;">
  <p style="margin: 0 0 8px; font-size: 13px; color: #A1A1AA;">WHAT DEFENDANTS SAY:</p>
  <p style="margin: 0 0 12px; font-style: italic; font-size: 14px; color: #D4D4D8;">"I didn't even know what to ask. The Case Decoder gave me questions I never would have thought of. My attorney's whole attitude changed after our next meeting."</p>
...
- Final email in the score re-engagement flow
- After this email: subscriber returns to general nurture/newsletter segment
- No further score-specific pitches unless subscriber retakes the quiz
- Suppress if subscriber purchased any tier since Email 3

## Performance Metrics to Track
- Open rate target: 20-28%
- Click rate target: 5-8%
- Case Decoder conversion rate: 4-7% (final pitch, most qualified segment)
- Revenue per email: key metric for this email specifically
