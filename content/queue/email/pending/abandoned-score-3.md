...
2. Your case is moving. Are you?
3. Nobody is going to tell you this

## Preview Text
The prosecution doesn't wait for you to get informed. Neither do deadlines.
...
<!--
  ...
  Delay: 72 hours after Email 2
  Segment: Score quiz abandoners who didn't convert after Emails 1 and 2
  Exit condition: Completes quiz + purchases any tier = exit flow

  Subject line: The cost of not knowing
...
<p>This is the last email we'll send about the Defense Milestone Score.</p>

<p>Here's what we know: you came to our site. You started the quiz. Something stopped you.</p>
...
<div style="margin: 20px 0; padding: 16px; border: 1px solid #27272A; border-radius: 8px; background: #1C1917;">
  <p style="margin: 0 0 12px; font-size: 14px; color: white; font-weight: bold;">What the Defense Milestone Score tells you in 60 seconds:</p>
  <ul style="padding-left: 20px; margin: 0; font-size: 13px; color: #D4D4D8;">
    <li style="margin-bottom: 6px;">Whether your attorney is hitting standard defense milestones for your case stage</li>
    <li style="margin-bottom: 6px;">Which areas of your defense have gaps that are worth asking about</li>
    <li style="margin-bottom: 6px;">How your case compares to benchmarks from elite defense practices</li>
    <li>Specific observations you can bring to your next attorney meeting</li>
  </ul>
</div>

<p>Free. Anonymous. No email required. 60 seconds.</p>

<p>After this, we won't remind you again. Your case, your call.</p>

<a href="https://imnotanattorney.com/score" style="display: inline-block; margin: 24px 0; padding: 14px 28px; background: #F59E0B; color: black; font-weight: bold; text-decoration: none; border-radius: 8px; font-size: 15px;">Take the Defense Milestone Score</a>
...
## CTA Button
**Text:** Take the Defense Milestone Score
...
- Quiz completion rate from email: 15%+
- Case Decoder direct conversion: 2-4%
