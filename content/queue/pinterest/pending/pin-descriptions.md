...
## Pin #1: 10-Day DMV Deadline

**Pin Title:** The 10-Day DUI Deadline Your Attorney Might Not Mention
**Destination URL:** https://imnotanattorney.com/blog/10-day-dmv-deadline
**Board:** DUI Defense Guide
**Pin Description:** After a DUI arrest, you have roughly 10 days to request a DMV hearing or your license gets suspended automatically. No exception. No extension. This deadline runs on a completely separate clock from your criminal case, and many attorneys treat it as an afterthought. Learn what the DMV hearing is, why it matters for your criminal defense, and what to ask your attorney immediately after a DUI arrest.
**Alt Text:** Infographic showing the 10-day DMV hearing deadline after a DUI arrest with a countdown clock visual, state-by-state deadline variations, and consequences of missing the deadline. Black background with amber countdown numbers and red warning accents.
**Pin Design Concept:**
- **Text overlay:** "10 DAYS. That's all you have." / "The DUI deadline nobody mentions" / "Save this now."
- **Color scheme:** Black background, large red "10" with amber countdown ring, white text
- **Visual style:** Countdown timer motif. Large "10" dominates the top third with a ticking clock ring in amber. Below: 3 state examples (CA, FL, TX) showing days and suspension lengths. Bottom third faded with "What happens when you miss it" teaser.
**Keywords:** DUI DMV hearing deadline, 10 day DMV hearing, DUI license suspension, DMV hearing after DUI, DUI arrest what to do, DUI deadline, DUI license revocation, administrative license suspension, DUI first offense timeline, DMV hearing request
**Cross-pin to boards:** Criminal Justice System Explained

---

## Pin #2: 10 Questions Every Defendant Should Ask
...
**Pin Description:** Walking into your attorney's office without questions is like going to a doctor's appointment without describing your symptoms. These 10 questions cover strategy, timeline, evidence, costs, and outcomes. Print this list. Bring it to your next meeting. Hold your defense accountable.
...
## Pin #3: 5 Questions for Your DUI Attorney
...
- **Color scheme:** Black background, large amber "5" at top, white text
- **Visual style:** Large amber "5" at top. Title in white bold. Below: 5 numbered items with amber numbers, only showing the first 2-3 question previews with text fading at the bottom. Small lock icon next to hidden questions. Bottom bar: amber stripe with "See all 5 at imnotanattorney.com"
**Keywords:** DUI attorney questions, DUI defense questions, questions to ask DUI lawyer, what to ask your DUI attorney before court, DUI defense strategy, DUI attorney accountability, DUI breathalyzer questions, DUI hearing preparation, DUI first offense questions, drunk driving defense
**Cross-pin to boards:** Criminal Defense Questions

---

## Pin #4: 7 Things the Criminal Justice System Won't Tell You
...
- **Color scheme:** Black background, amber numbered items with lock/unlock icons, white text
- **Visual style:** Title at top in bold white. Below: 7 items arranged vertically. Items 1-3 shown as "UNLOCKED" (amber lock icon, open) with brief previews: "The trial penalty is real," "Your public defender carries 200+ cases," "97% of federal cases end in pleas." Items 4-7 shown as "LOCKED" (closed lock icons) with blurred text. CTA: "Unlock all 7 at imnotanattorney.com." Amber accent bar at bottom.
**Keywords:** criminal justice system secrets, what defendants should know, trial penalty explained, public defender caseload, criminal justice system truth, defendant rights information, how criminal justice works, plea deal statistics, criminal court system, things nobody tells defendants
**Cross-pin to boards:** Criminal Justice System Explained

---

## Pin #5: Attorney Not Returning Calls
...
## Pin #6: Breathalyzer Calibration Records
...
## Pin #7: Can Criminal Charges Be Dropped?
...
**Board:** DUI Defense Guide
**Pin Description:** DUI charges are not automatic convictions. From illegal traffic stops to faulty breathalyzers to improper field sobriety tests, there are real defense angles that lead to dismissal or reduction. These 7 angles are what your attorney should be investigating. If they are not, ask why.
...
**Pin Design Concept:**
- **Text overlay:** "7 Ways a DUI Can Be Dismissed" / "Your attorney should be checking all of these"
...
- **Color scheme:** Black background, amber stage markers on a vertical timeline, white text, subtle blue/red police light accent at top
- **Visual style:** Top: "The Complete DUI Defense Guide" with subtle blue/red light reflection. Vertical timeline descending through stages: Arrest > Field Tests > Chemical Test > Booking > DMV Deadline (highlighted in amber pulse) > Arraignment > Discovery > Motions > [faded]. Each stage shows one key question. Bottom half fades with "See every stage at imnotanattorney.com." This pin positions the blog post as the definitive DUI resource.
**Keywords:** DUI defense guide, complete DUI defense, DUI case process, DUI arrest what to do, DUI attorney guide, DUI defense strategy, DUI case timeline, DUI charge defense, how to fight a DUI, DUI first offense guide
**Cross-pin to boards:** Criminal Defense Questions
...
## Pin #12: Discovery Rights in Drug Cases
...
- **Color scheme:** Black background, amber document outlines, white text
- **Visual style:** Title at top. Center: visual stack of document icons (police report, lab report, video tape, evidence bag) arranged in a grid with amber outlines and labels. Checkmark/question mark next to each: "Have you seen this?" Bottom faded with "Full guide inside" CTA.
**Keywords:** discovery rights drug cases, drug charge evidence, criminal discovery explained, what evidence should attorney have, drug case discovery, evidence in drug case, discovery documents criminal, right to see evidence, drug charge defense, criminal evidence review
...
**Board:** White Collar & Federal Defense
**Pin Description:** The FBI showed up. Or a target letter arrived. Or your business partner just got indicted. Federal investigations are slow, methodical, and already well advanced by the time you find out about them. What a target letter means, the difference between target and subject and witness, the critical 48-hour window, and why talking to federal agents without an attorney is the most dangerous thing you can do.
**Alt Text:** Infographic showing what to expect during a federal criminal investigation, including target letter explanation, the difference between target and subject classifications, and immediate steps to take. Dark background with amber urgency markers.
**Pin Design Concept:**
...
## Pin #14: Feels Like Your Lawyer Is Working Against You
...
**Board:** Attorney Accountability
**Pin Description:** You are paying your attorney to defend you but everything they do seems to benefit the prosecution. Pushing a plea you don't want. Not filing motions. Not sharing your discovery. Before you panic, here is what might actually be happening and the questions that separate bad strategy from bad faith.
...
## Pin #15: Field Sobriety Test Standards
...
## Pin #16: Field Test vs Lab Test in Drug Cases

**Pin Title:** Field Drug Test vs Lab Test: Why That "Positive" Might Be Wrong
**Destination URL:** https://imnotanattorney.com/blog/field-test-vs-lab-test-drug-cases
**Board:** Drug Charge Defense
...
## Pin #19: How Often Should Your Attorney Communicate
...
**Board:** Attorney Accountability
**Pin Description:** Once a week? Once a month? Never unless you call first? There are actual standards for attorney-client communication in criminal cases and most defendants don't know them. Here is what reasonable communication looks like, what counts as a red flag, and exactly what to say when you are being ignored.
**Alt Text:** Infographic showing communication frequency standards between criminal defense attorneys and their clients, with examples of reasonable versus unreasonable communication patterns. Dark theme with amber visual indicators.
**Pin Design Concept:**
...
**Pin Design Concept:**
- **Text overlay:** "How Your Attorney Makes Money" / "The fee structure shapes your defense"
- **Color scheme:** Black background, amber column headers, white text
- **Visual style:** Three columns: "Flat Fee" / "Hourly" / "Public Defender." Each column shows dollar icon and brief incentive description. Below columns: "What this means for YOUR case" section, partially visible. Amber accents on headers.
**Keywords:** how criminal defense attorney gets paid, criminal defense attorney fees, retainer vs hourly lawyer, criminal defense cost, attorney fee structure, how attorneys charge, legal fees criminal case, retainer fee criminal, public defender vs paid attorney cost, defense attorney pricing
**Cross-pin to boards:** Defendant Resources

---

## Pin #23: Is Your Attorney Actually Working Your Case?
...
**Board:** Attorney Accountability
**Pin Description:** You paid a retainer. Your court date keeps getting pushed. Your attorney says everything is fine. But how do you actually know if they are building a defense or just waiting for the clock to run? These 7 warning signs tell you whether your money is being earned. Save this before your next status call.
...
**Pin Design Concept:**
- **Text overlay:** "7 Signs Your Attorney Isn't Working Your Case" / "Is your money being earned?"
- **Color scheme:** Black background, amber warning triangle, white numbered list
- **Visual style:** Amber warning triangle at top. Numbered list with warning icons. First 4 signs visible (e.g., "No motions filed after 30 days"). Signs 5-7 covered with dark gradient + "See all 7" CTA.
**Keywords:** is my attorney working my case, attorney not working, lazy criminal defense lawyer, signs attorney not doing job, attorney accountability, criminal defense red flags, attorney warning signs, is my lawyer doing anything, defense attorney performance, attorney not filing motions
**Cross-pin to boards:** Criminal Defense Questions
...
- **Color scheme:** Black background, amber dividing line, white text in two columns
- **Visual style:** Two-column layout. Left: "Public Defender" with 5 comparison points. Right: "Private Attorney" with same 5. First 3 rows filled, rows 4-5 blurred. "Read the full comparison" CTA.
**Keywords:** public defender vs private attorney, should I get a public defender, private attorney worth it, is a private attorney better, public defender caseload, public defender vs paid lawyer, choosing criminal defense attorney, public defender experience, criminal defense comparison, appointed attorney vs hired
**Cross-pin to boards:** Criminal Justice System Explained

---

## Pin #25: Questions Before Hiring a Criminal Defense Attorney
...
- **Color scheme:** Black background, amber clipboard icon, white numbered list
- **Visual style:** Notepad/clipboard icon at top. Numbered list showing questions 1-3. Questions 4-8 blurred. Callout: "Question #5 reveals everything about their fee structure." CTA bar at bottom.
**Keywords:** questions to ask before hiring criminal defense attorney, how to choose criminal defense lawyer, hiring defense attorney, attorney consultation questions, what to ask criminal lawyer, defense attorney interview, criminal defense retainer, hiring a lawyer for criminal case, attorney selection questions, defense lawyer questions
**Cross-pin to boards:** Defendant Resources

---

## Pin #26: Should You Fire Your Lawyer?
...
## Pin #27: Should You Take the Plea Deal?
...
**Board:** Criminal Defense Questions
**Pin Description:** Your attorney is pushing a plea deal. The prosecutor says it is a good offer. But is it? Before you sign anything, these 6 questions will help you understand what you are giving up, what you are getting, and whether your attorney actually explored every alternative. Your freedom. Your decision.
...
**Pin Design Concept:**
- **Text overlay:** "Should You Take the Plea Deal?" / "6 questions before you sign anything"
- **Color scheme:** Black background, amber vs white two-column top ("TAKE IT" vs "FIGHT IT"), white numbered list
- **Visual style:** Split top: "TAKE IT" vs "FIGHT IT" with dividing line. Below: "Ask these 6 questions first." Numbered list, first 3 visible, last 3 faded. Bottom: "Your freedom. Your decision." tagline + URL.
**Keywords:** should I take the plea deal, plea deal questions, plea bargain criminal case, questions before accepting plea, plea deal evaluation, plea deal vs trial, trial penalty, plea deal rights, criminal plea negotiation, plea agreement questions
**Cross-pin to boards:** Criminal Justice System Explained

---

## Pin #28: Trafficking Charges and Constructive Possession
...
## Pin #29: What 500 Pages of Drug Discovery Contained

**Pin Title:** What 500 Pages of Drug Trafficking Discovery Actually Contained
**Destination URL:** https://imnotanattorney.com/blog/what-500-pages-of-drug-trafficking-discovery-contained
**Board:** Drug Charge Defense
**Pin Description:** A defendant opened his own 500-page discovery file and found four critical issues his attorney never mentioned. A 73% weight discrepancy. A confidential informant phone number matching the defendant's. A drug type mismatch between the charges and the lab results. Zero fingerprint matches out of 21 prints. His attorney had filed nothing on any of it.
**Alt Text:** Case study infographic showing four critical evidence problems found in a 500-page drug trafficking discovery file that the defense attorney never raised, including weight discrepancy, informant issues, drug type mismatch, and fingerprint evidence. Dark background with amber document and evidence icons.
**Pin Design Concept:**
...
## Pin #31: What Happens If Your Attorney Misses a Deadline
...
**Board:** Attorney Accountability
**Pin Description:** Court deadlines are not suggestions. When your criminal defense attorney misses a filing deadline, it can affect your case in ways that range from inconvenient to catastrophic. Here is what different missed deadlines actually mean, your options for recourse, and the questions to ask right now.
...
**Pin Design Concept:**
- **Text overlay:** "Your Attorney Missed a Deadline" / "Some are minor. Some are catastrophic. Know the difference."
...
## Pin #32: What Motions Should Your Attorney Be Filing?
...
- **Color scheme:** Black background, amber-bordered motion cards, white text
- **Visual style:** 4-5 motion types as card-style blocks. Each card: motion name in bold, 1-line description. "Motion to Suppress" and "Motion to Dismiss" fully visible. Others partially visible, fading. CTA: "Full breakdown at imnotanattorney.com."
**Keywords:** motions attorney should file, motion to suppress, criminal defense motions, motion to dismiss, motion to compel, criminal motions explained, defense motions types, pre-trial motions, suppression motion, criminal defense strategy motions
**Cross-pin to boards:** Attorney Accountability
...
- **Color scheme:** Black background, amber timeline dots, white text, highlighted amber for DMV deadline
- **Visual style:** Vertical timeline: Arrest > Booking > Bail > DMV Deadline (highlighted with "10 days!" callout) > Arraignment > Pre-Trial > [faded]. DMV deadline gets extra emphasis. Each stage has time marker (Day 1, Day 10, etc.).
**Keywords:** what to expect after DUI arrest, DUI arrest timeline, after DUI arrest what happens, DUI first offense what to expect, DUI arrest process, DUI booking process, DUI arraignment, DUI case timeline, first DUI what happens, arrested for DUI next steps
**Cross-pin to boards:** Criminal Justice System Explained

---

## Pin #34: Why Is My Criminal Case Taking So Long?
...
## Pin #35: Wire Fraud Defense Questions

**Pin Title:** Wire Fraud Charges? 15 Questions Your Attorney Must Answer
**Destination URL:** https://imnotanattorney.com/blog/wire-fraud-defense-questions
**Board:** White Collar & Federal Defense
**Pin Description:** Wire fraud carries up to 20 years per count. If the fraud affects a financial institution, 30 years per count. This is not a charge where "we're working on it" is an acceptable answer from your attorney. These 15 questions cover intent evidence, good faith defenses, loss calculations, cooperation options, and sentencing exposure. If your attorney cannot answer them, you need to know that before your next hearing.
**Alt Text:** Infographic listing 15 critical questions a wire fraud defendant should ask their defense attorney, organized by category: intent, evidence, cooperation, and sentencing. Dark background with amber numbered questions and federal building silhouette.
**Pin Design Concept:**
...
## Fresh Pin Variant Strategy (All 35 Posts)
