...
-- + co_defendant_analysis recreation (accidentally dropped in 20260411c)
...
--         citation_authority, data_source_freshness, co_defendant_analysis (recreated)
--
-- NOTE: This file documents schema already applied to production via Management API.
...
-- ── co_defendant_analysis (recreated — accidentally dropped in 20260411c) ──
