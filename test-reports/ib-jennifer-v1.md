...
Federal white collar cases follow a distinct timeline. Here is the typical path at this stage:

**Stage 1: Status Conference (June 12, 2026)**
...
**Stage 5: Resolution**
The case resolves through dismissal, negotiated plea with a sentencing recommendation, cooperation agreement, or trial.
...
**CLARIFY: What "we need to see what they have" means specifically.** After 5 months, you're entitled to an update on what he has seen, what's outstanding, and what his initial assessment is.
...
If a plea is eventually offered, federal plea negotiations work differently from state cases:

**Before evaluating any federal plea, explore these questions:**

1. "What is the Guidelines range based on the government's loss calculation versus your assessment?"
2. "Am I eligible for a minimal role adjustment under § 3B1.2?"
3. "What does acceptance of responsibility (§ 3E1.1) look like in terms of timing?"
4. "Is cooperation (§ 5K1.1) an option, and what would that involve?"

**What a federal wire fraud conviction means for your record:** Under 18 U.S.C. § 1343, wire fraud is a federal felony carrying up to 20 years per count and fines up to $250,000. A conviction creates a permanent federal criminal record. Federal convictions cannot be expunged. Supervised release typically follows any sentence. Restitution to victims is mandatory under the Mandatory Victims Restitution Act (18 U.S.C. § 3663A). Professional licensing consequences vary by state but are typically severe for financial professionals.
...
**Your next court date:** June 12, 2026
**Hearing type:** Status conference
**Judge:** Judge Sarah Kim
**Location:** United States Courthouse, Northern District of California (confirm exact courtroom with Rothstein or the clerk's office)
...
- Federal court has higher formality expectations than state court
- The standard: look like a professional the judge takes seriously
...
Federal public defenders occasionally have scheduling conflicts across multiple courtrooms:
1. Tell the judge: "Your Honor, I'm represented by David Rothstein from the Federal Public Defender's office. I believe he may be in another courtroom."
2. The judge will typically continue the matter briefly or contact the FPD office.
3. Do not try to represent yourself or discuss the matter.
4. After the hearing, contact the FPD office immediately and document what happened.
...
1. **Sentencing patterns:** "How does Judge Kim typically sentence in white collar cases? Does she tend to follow the recommended range or depart?"
...
An attorney who has appeared before Judge Kim can calibrate strategy based on her patterns. If Rothstein hasn't, asking him to consult a colleague in the FPD office who has is standard practice.
...
Could we schedule a brief call or meeting before the status conference? I'm available any time that works for you.
...
I'm following up on my email from [date]. I want to make sure my questions reached you before the status conference:

1. Based on the evidence so far, what is your initial read on the government's theory against me specifically?
2. What do the financial records and emails show about my role versus his directives?
3. Have you run an initial sentencing calculation based on the loss figure and my role?
4. Am I eligible for a minimal role adjustment under § 3B1.2?
5. What is the total financial exposure under the government's current theory?
...
**Bring this to your next meeting with David Rothstein:**
...
**Q2:** "What do the financial records and emails show about my role versus the CEO's directives? Is there evidence supporting a good faith defense?"
Attorney's answer: _________________________________________________

**Q3:** "Have you run an initial sentencing calculation? What is the range based on the government's loss figure?"
Attorney's answer: _________________________________________________
...
- [ ] Understand what happens at the status conference
...
What you can say: "Before I decide anything about cooperation, I want to understand all the options. Could you walk me through what a § 5K1.1 motion involves, what I'd need to provide, and how it compares to a straight plea with acceptance of responsibility?"
Why it works: Gathers information without committing. Cooperation is a major decision that requires full understanding.
...
**Q4:** "Have you run an initial sentencing calculation? What offense level, loss amount, and role adjustment are we looking at?"

The Sentencing Guidelines calculation (U.S.S.G. § 2B1.1 for fraud) is the foundation of every federal plea discussion. Key variables:
- **Base offense level:** 7 for fraud
- **Loss enhancement:** Increases based on loss amount (this is where the biggest jumps happen)
- **Role adjustment:** Minimal participant (§ 3B1.2) reduces by 2-4 levels; organizer/leader (§ 3B1.1) increases
- **Acceptance of responsibility:** 2-3 level reduction (§ 3E1.1) if timely

Without this calculation, evaluating any plea offer is impossible. If he hasn't run it: "Could you run an initial estimate this week? I'd like to understand the range before the status conference."
...
**Q6:** "What discovery is still outstanding? When do you expect the government to produce internal emails and investor communications?"

| 🟢 Green flag | 🔴 Red flag |
|---|---|
| He lists specific categories produced and outstanding | "I think we have most of it" without specifics |
| Gives a timeline for outstanding production | Can't describe what's been received |
| Has organized the documents by relevance | Hasn't reviewed the production yet |
...
**Q9:** "If the government offers a plea, how do I evaluate whether it's fair? What is the standard plea structure for wire fraud in this district?"

- **If he describes a typical plea →** Ask how it compares to your specific sentencing calculation
...
**Q11:** "What is Judge Kim's approach to white collar cases? Does she tend to follow the recommended range or sentence independently?"

Federal judges have wide discretion after *United States v. Booker*, 543 U.S. 220 (2005), which made the Sentencing Guidelines advisory. Some judges follow them closely; others depart significantly. Understanding the judge's pattern is critical for both plea evaluation and trial strategy. If Rothstein hasn't appeared before her, asking a colleague in the FPD office is standard and expected.
