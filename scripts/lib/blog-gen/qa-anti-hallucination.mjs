...
3. STATISTICS_CHECK: Extract every statistic (any number that makes a factual claim — percentages, counts, rates, dollar amounts, time windows). Every statistic must have a named source in parentheses within the same sentence or the immediately preceding sentence. Example format: "97% of federal cases end in guilty pleas (Bureau of Justice Statistics, 2022)". FAIL if ANY statistic appears without a named source AND without general/jurisdictional phrasing. PASS if every number is either (a) sourced with a named source, (b) phrased generally ("the vast majority", "most", "many"), OR (c) presented as a jurisdiction-qualified range ("Many states require 15 to 30 days", "can take 4 to 8 weeks depending on the jurisdiction"). Jurisdiction-qualified ranges are general approximations, not precise claims — they PASS.
...
5. CASE_NAME_CHECK: Scan for any legal case citation (e.g. "Smith v. Jones", "Terry v. Ohio"). No case citations are allowed in pre-purchase blog content. FAIL if ANY case citation appears. EXCEPTIONS — these terms are so universally known they function as legal terminology, NOT case citations: "Brady material", "Brady obligations", "Brady motion", "Brady v. Maryland", "Daubert motion", "Daubert challenge", "Daubert hearing", "Daubert v. Merrell Dow", "Daubert standard", "Frye standard", "Frye hearing", "Daubert/Frye", "Miranda rights", "Miranda warning", "Miranda violation", "Franks hearing", "Franks motion", "Franks v. Delaware", "Franks challenge". PASS if no case citations appear (or only the listed terminology).
